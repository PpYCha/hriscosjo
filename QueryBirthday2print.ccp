<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="500" connection="Connection1" dataSource="departmentoffice, employee, lut_sex, lut_statofappt2" orderBy="employee.Surname" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Sex " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			<Components>
...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="QueryBirthday2print_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="QueryBirthday2print.php" forShow="True" url="QueryBirthday2print.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
