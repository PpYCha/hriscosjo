<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Print" sourceType="Table" returnValueType="Number" linesPerWebPage="40" connection="Connection1" dataSource="departmentoffice, employee, lut_servicerecpurpose, lut_statofappt2" activeCollection="TableParameters" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Servicerecpurpose " wizardLayoutType="Tabular" pasteActions="pasteActions">
			<Components>
				...
				<Section id="34" visible="True" lines="1" name="Detail" pasteActions="pasteActions">
					<Components>
						...
						<Hidden id="74" fieldSourceType="DBColumn" dataType="Text" name="Hidden2" PathID="departmentoffice_employee1DetailHidden2" fieldSource="NameExtension">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="78" fieldSourceType="DBColumn" dataType="Text" name="Hidden3" PathID="departmentoffice_employee1DetailHidden3" fieldSource="StatApp">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="79" fieldSourceType="DBColumn" dataType="Text" name="Hidden4" PathID="departmentoffice_employee1DetailHidden4" fieldSource="OrigApptMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="80" fieldSourceType="DBColumn" dataType="Text" name="Hidden5" PathID="departmentoffice_employee1DetailHidden5" fieldSource="OrigApptDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="81" fieldSourceType="DBColumn" dataType="Text" name="Hidden6" PathID="departmentoffice_employee1DetailHidden6" fieldSource="OrigApptYear">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="85" fieldSourceType="DBColumn" dataType="Text" name="Hidden7" PathID="departmentoffice_employee1DetailHidden7" fieldSource="Rate">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<JoinTables>
				...
				<JoinTable id="4" tableName="employee" posLeft="160" posTop="10" posWidth="160" posHeight="254"/>
				<JoinTable id="6" tableName="lut_servicerecpurpose" posLeft="341" posTop="10" posWidth="128" posHeight="88"/>
				<JoinTable id="75" tableName="lut_statofappt2" posLeft="361" posTop="131" posWidth="95" posHeight="88"/>
			</JoinTables>
			<JoinLinks>
				...
				<JoinTable2 id="76" tableLeft="employee" tableRight="lut_statofappt2" fieldLeft="employee.StatAppID" fieldRight="lut_statofappt2.StatAppID" joinType="inner" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="73" tableName="employee" fieldName="NameExtension"/>
				<Field id="77" tableName="lut_statofappt2" fieldName="lut_statofappt2.*"/>
				<Field id="82" tableName="employee" fieldName="OrigApptMonth"/>
				<Field id="83" tableName="employee" fieldName="OrigApptDay"/>
				<Field id="84" tableName="employee" fieldName="OrigApptYear"/>
				<Field id="86" tableName="employee" fieldName="Rate"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_latestsalary_print.php" forShow="True" url="Cert_latestsalary_print.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_latestsalary_print_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
