<?php
//Include Common Files @1-C6B967CE
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryBirthdays.php");
...
//employee_departmentoffice ReportGroup class @2-04545309
...
//employee_departmentoffice GroupsCollection class @2-B2BAACCB
...
//Class_Initialize Event @2-77E2692E
...
//DataSource Variables @2-FBB321E8
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-623EBCB9
...
//Prepare Method @2-4F385458
    function Prepare()
    {
        ...
        $this->wp->AddParameter("6", "urls_BirthMonth", ccsText, "", "", $this->Parameters["urls_BirthMonth"], "", false);
        $this->wp->AddParameter("7", "urls_BirthDay", ccsText, "", "", $this->Parameters["urls_BirthDay"], "", false);
        $this->wp->AddParameter("8", "urls_BirthYear", ccsText, "", "", $this->Parameters["urls_BirthYear"], "", false);
        ...
        $this->wp->AddParameter("11", "urls_StatAppt", ccsText, "", "", $this->Parameters["urls_StatAppt"], "", false);
        ...
        $this->wp->Criterion[6] = $this->wp->Operation(opContains, "BirthMonth", $this->wp->GetDBValue("6"), $this->ToSQL($this->wp->GetDBValue("6"), ccsText),false);
        $this->wp->Criterion[7] = $this->wp->Operation(opContains, "BirthDay", $this->wp->GetDBValue("7"), $this->ToSQL($this->wp->GetDBValue("7"), ccsText),false);
        $this->wp->Criterion[8] = $this->wp->Operation(opContains, "BirthYear", $this->wp->GetDBValue("8"), $this->ToSQL($this->wp->GetDBValue("8"), ccsText),false);
        ...
        $this->wp->Criterion[11] = $this->wp->Operation(opContains, "StatAppt", $this->wp->GetDBValue("11"), $this->ToSQL($this->wp->GetDBValue("11"), ccsText),false);
...
//Open Method @2-8830A66B
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT OfficeAcronym, EmployeeIDNo, Surname, FirstName, MiddleName, BirthMonth, BirthDay, BirthYear, NameExtension, PlaceOfBirth,\n\n" .
        "Sex, CivilStatus, employee.Position AS employee_Position, StatAppt, employee.OfficeID AS employee_OfficeID \n\n" .
...
//Class_Initialize Event @22-04FE411C
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_employee_OfficeID", "s_EmployeeIDNo", "s_Surname", "s_FirstName", "s_MiddleName", "s_BirthMonth", "s_BirthDay", "s_BirthYear", "s_Sex", "s_CivilStatus", "s_StatAppt", "ccsForm"));
            $this->ClearParameters->Page = "QueryBirthdays.php";
...
//CheckErrors Method @22-E913C50D
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-6ACFF86E
    function Operation()
    {
        ...
        $Redirect = "QueryBirthdays.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryBirthdays.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryBirthdays.html";
$BlockToParse = "main";
...
//Include events file @1-3FDCD8E4
include_once("./QueryBirthdays_events.php");
...
$Report_Print->Page = "QueryBirthdays.php";
