<?php
//Include Common Files @1-BD351421
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryCSC.php");
...
//departmentoffice_employee1 ReportGroup class @2-C6D82DD7
class clsReportGroupdepartmentoffice_employee1 {
    ...
    var $employee_Sex, $_employee_SexAttributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->employee_Sex = $this->Parent->employee_Sex->Value;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_employee_SexAttributes = $this->Parent->employee_Sex->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->employee_Sex = $Header->employee_Sex;
        $Header->_employee_SexAttributes = $this->_employee_SexAttributes;
        $this->Parent->employee_Sex->Value = $Header->employee_Sex;
        $this->Parent->employee_Sex->Attributes->RestoreFromArray($Header->_employee_SexAttributes);
...
//departmentoffice_employee1 GroupsCollection class @2-8BE0F762
class clsGroupsCollectiondepartmentoffice_employee1 {
    ...
    function RestoreValues() {
        ...
        $this->Parent->employee_Sex->Value = $this->Parent->employee_Sex->initialValue;
...
//Class_Initialize Event @2-A4805332
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->employee_Sex = & new clsControl(ccsReportLabel, "employee_Sex", "employee_Sex", ccsText, "", "", $this);
        ...
        $this->ReportLabel6 = & new clsControl(ccsReportLabel, "ReportLabel6", "ReportLabel6", ccsDate, array("mm", "/", "dd", "/", "yyyy"), "", $this);
...
//CheckErrors Method @2-51C933E1
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->employee_Sex->Errors->Count());
...
//GetErrors Method @2-59FAF009
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->employee_Sex->Errors->ToString());
...
//Show Method @2-F92FB84D
    function Show()
    {
        ...
        $this->DataSource->Parameters["urls_BirthMonth"] = CCGetFromGet("s_BirthMonth", NULL);
        $this->DataSource->Parameters["urls_BirthDay"] = CCGetFromGet("s_BirthDay", NULL);
        $this->DataSource->Parameters["urls_BirthYear"] = CCGetFromGet("s_BirthYear", NULL);
        ...
        while($is_next_record) {
            ...
            $this->employee_Sex->SetValue($this->DataSource->employee_Sex->GetValue());
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["employee_Sex"] = $this->employee_Sex->Visible;
            ...
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->employee_Sex->SetValue($items[$i]->employee_Sex);
                        $this->employee_Sex->Attributes->RestoreFromArray($items[$i]->_employee_SexAttributes);
...
//DataSource Variables @2-DFC43230
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-DFAB09C2
    function clsdepartmentoffice_employee1DataSource(& $Parent)
    {
        ...
        $this->employee_Sex = new clsField("employee_Sex", ccsText, "");
        ...
        $this->ReportLabel6 = new clsField("ReportLabel6", ccsDate, $this->DateFormat);
...
//Prepare Method @2-67F83BA2
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urls_BirthMonth", ccsText, "", "", $this->Parameters["urls_BirthMonth"], "", false);
        $this->wp->AddParameter("3", "urls_BirthDay", ccsText, "", "", $this->Parameters["urls_BirthDay"], "", false);
        $this->wp->AddParameter("4", "urls_BirthYear", ccsText, "", "", $this->Parameters["urls_BirthYear"], "", false);
        $this->wp->AddParameter("5", "urlCheckBoxList1", ccsText, "", "", $this->Parameters["urlCheckBoxList1"], "", false);
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "employee.BirthMonth", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opEqual, "employee.BirthDay", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opEqual, "employee.BirthYear", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
        $this->wp->Criterion[5] = $this->wp->Operation(opIn, "lut_statofappt2.StatApp", $this->wp->GetDBValue("5"), $this->ToSQL($this->wp->GetDBValue("5"), ccsText, true),false);
...
//Open Method @2-1216C21A
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT OfficeAcronym, Surname, FirstName, MiddleName, BirthMonth, BirthDay, BirthYear, employee.Sex AS employee_Sex, PlaceOfBirth,\n\n" .
        "CivilStatus, lut_sex.Sex AS lut_sex_Sex, employee.OfficeID AS employee_OfficeID, BirthDate, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), BirthDate)), '%Y') + 0 AS Expr1,\n\n" .
        "lut_statofappt2.*, employee.Position AS employee_Position, NameExtension, MiddleInitial \n\n" .
        "FROM ((employee INNER JOIN departmentoffice ON\n\n" .
        "employee.OfficeID = departmentoffice.OfficeID) INNER JOIN lut_sex ON\n\n" .
        "employee.Sex = lut_sex.SexID) INNER JOIN lut_statofappt2 ON\n\n" .
...
//SetValues Method @2-7A97525C
    function SetValues()
    {
        ...
        $this->employee_Sex->SetDBValue($this->f("lut_sex_Sex"));
        ...
        $this->ReportLabel2->SetDBValue($this->f("Expr1"));
        $this->ReportLabel3->SetDBValue($this->f("StatApp"));
        $this->ReportLabel1->SetDBValue($this->f("employee_Position"));
        $this->ReportLabel4->SetDBValue($this->f("NameExtension"));
        $this->ReportLabel6->SetDBValue(trim($this->f("BirthDate")));
        $this->ReportLabel7->SetDBValue($this->f("MiddleInitial"));
    }
//End SetValues Method

} //End departmentoffice_employee1DataSource Class @2-FCB6E20C

class clsRecorddepartmentoffice_employee { //departmentoffice_employee Class @23-B39F2074
...
//Class_Initialize Event @23-520BD301
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_employee_OfficeID", "s_BirthMonth", "s_BirthDay", "s_BirthYear", "CheckBoxList1", "ccsForm"));
            $this->ClearParameters->Page = "QueryCSC.php";
...
"FROM departmentoffice {SQL_Where} {SQL_OrderBy}";
            ...
            $this->s_employee_OfficeID->DataSource->Order = "OfficeAcronym";
            $this->s_BirthMonth = & new clsControl(ccsListBox, "s_BirthMonth", "s_BirthMonth", ccsText, "", CCGetRequestParam("s_BirthMonth", $Method, NULL), $this);
            $this->s_BirthMonth->DSType = dsTable;
            $this->s_BirthMonth->DataSource = new clsDBConnection1();
            $this->s_BirthMonth->ds = & $this->s_BirthMonth->DataSource;
            $this->s_BirthMonth->DataSource->SQL = "SELECT * \n" .
"FROM lut_month {SQL_Where} {SQL_OrderBy}";
            list($this->s_BirthMonth->BoundColumn, $this->s_BirthMonth->TextColumn, $this->s_BirthMonth->DBFormat) = array("Month", "Month", "");
            $this->s_BirthDay = & new clsControl(ccsListBox, "s_BirthDay", "s_BirthDay", ccsText, "", CCGetRequestParam("s_BirthDay", $Method, NULL), $this);
            $this->s_BirthDay->DSType = dsTable;
            $this->s_BirthDay->DataSource = new clsDBConnection1();
            $this->s_BirthDay->ds = & $this->s_BirthDay->DataSource;
            $this->s_BirthDay->DataSource->SQL = "SELECT * \n" .
"FROM lut_day {SQL_Where} {SQL_OrderBy}";
            list($this->s_BirthDay->BoundColumn, $this->s_BirthDay->TextColumn, $this->s_BirthDay->DBFormat) = array("Day", "Day", "");
            $this->s_BirthYear = & new clsControl(ccsTextBox, "s_BirthYear", "s_BirthYear", ccsText, "", CCGetRequestParam("s_BirthYear", $Method, NULL), $this);
...
//Validate Method @23-47BB14A3
    function Validate()
    {
        ...
        $Validation = ($this->s_BirthMonth->Validate() && $Validation);
        $Validation = ($this->s_BirthDay->Validate() && $Validation);
        $Validation = ($this->s_BirthYear->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->s_BirthMonth->Errors->Count() == 0);
        $Validation =  $Validation && ($this->s_BirthDay->Errors->Count() == 0);
        $Validation =  $Validation && ($this->s_BirthYear->Errors->Count() == 0);
        $Validation =  $Validation && ($this->CheckBoxList1->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @23-D2D48536
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->ClearParameters->Errors->Count());
        $errors = ($errors || $this->s_employee_OfficeID->Errors->Count());
        $errors = ($errors || $this->s_BirthMonth->Errors->Count());
        $errors = ($errors || $this->s_BirthDay->Errors->Count());
        $errors = ($errors || $this->s_BirthYear->Errors->Count());
...
//Operation Method @23-8467CFF5
    function Operation()
    {
        ...
        $Redirect = "QueryCSC.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryCSC.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @23-971078BD
    function Show()
    {
        ...
        $this->s_BirthMonth->Prepare();
        $this->s_BirthDay->Prepare();
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->s_BirthMonth->Errors->ToString());
            $Error = ComposeStrings($Error, $this->s_BirthDay->Errors->ToString());
            $Error = ComposeStrings($Error, $this->s_BirthYear->Errors->ToString());
        ...
        $this->s_BirthMonth->Show();
        $this->s_BirthDay->Show();
        $this->s_BirthYear->Show();
...
} //End departmentoffice_employee Class @23-FCB6E20C

//Initialize Page @1-23D47058
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryCSC.html";
$BlockToParse = "main";
...
//Include events file @1-417088BF
include_once("./QueryCSC_events.php");
...
$Report_Print->Page = "QueryBirthday2print.php";
