...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_emp_compensatnAPGDH_print.php" forShow="True" url="Cert_emp_compensatnAPGDH_print.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_emp_compensatnAPGDH_print_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
