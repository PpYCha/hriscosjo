<?php
//Include Common Files @1-5CC92E41
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QMembership.php");
...
//employee_membershipassoco ReportGroup class @2-68669EFB
class clsReportGroupemployee_membershipassoco {
    var $GroupType;
    ...
    function clsReportGroupemployee_membershipassoco(& $parent) {
        $this->Parent = & $parent;
...
//End employee_membershipassoco ReportGroup class

//employee_membershipassoco GroupsCollection class @2-BCFA1EDC
class clsGroupsCollectionemployee_membershipassoco {
    var $Groups;
    ...
    function clsGroupsCollectionemployee_membershipassoco(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupemployee_membershipassoco($this->Parent);
...
//End employee_membershipassoco GroupsCollection class

class clsReportemployee_membershipassoco { //employee_membershipassoco Class @2-E3622939

//employee_membershipassoco Variables @2-87F7EA53
...
//End employee_membershipassoco Variables

//Class_Initialize Event @2-39FDEF95
    function clsReportemployee_membershipassoco($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
...
//Show Method @2-081F0C4E
    function Show()
    {
        ...
        $Groups = new clsGroupsCollectionemployee_membershipassoco($this);
...
//DataSource Variables @2-D0428E43
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-4F236DF3
    function clsemployee_membershipassocoDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report employee_membershipassoco";
        $this->Initialize();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QMembership.html";
$BlockToParse = "main";
...
//Include events file @1-2254C114
include_once("./QMembership_events.php");
...
// Controls
$employee_membershipassoco = & new clsReportemployee_membershipassoco("", $MainPage);
...
//Go to destination page @1-9DABF8AD
if($Redirect)
{
