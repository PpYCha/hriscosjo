<?php
//Include Common Files @1-BBC0FB46
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ConstantFactor.php");
...
//Class_Initialize Event @2-B25EDF82
    function clsGridemployee($RelativePath, & $Parent)
    {
        ...
        $this->EmployeeIDNo = & new clsControl(ccsLink, "EmployeeIDNo", "EmployeeIDNo", ccsText, "", CCGetRequestParam("EmployeeIDNo", ccsGet, NULL), $this);
        $this->EmployeeIDNo->Page = "ConstantFactor.php";
        ...
        $this->ConstantFactor = & new clsControl(ccsLabel, "ConstantFactor", "ConstantFactor", ccsSingle, "", CCGetRequestParam("ConstantFactor", ccsGet, NULL), $this);
        ...
        $this->employee_Insert->Page = "ConstantFactor.php";
...
//Show Method @2-1BF2AEE7
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["ConstantFactor"] = $this->ConstantFactor->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->EmployeeIDNo->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                $this->EmployeeIDNo->Parameters = CCAddParam($this->EmployeeIDNo->Parameters, "EmployeeID", $this->DataSource->f("EmployeeID"));
                ...
                $this->ConstantFactor->SetValue($this->DataSource->ConstantFactor->GetValue());
...
//GetErrors Method @2-E15861F3
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->ConstantFactor->Errors->ToString());
...
//DataSource Variables @2-7866E1E6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-323E9E9F
    function clsemployeeDataSource(& $Parent)
    {
        ...
        $this->ConstantFactor = new clsField("ConstantFactor", ccsSingle, "");
...
//Open Method @2-6280A411
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM employee";
        $this->SQL = "SELECT EmployeeIDNo, Surname, FirstName, MiddleName, ConstantFactor, EmployeeID \n\n" .
...
//SetValues Method @2-24178C56
    function SetValues()
    {
        ...
        $this->ConstantFactor->SetDBValue(trim($this->f("ConstantFactor")));
    }
//End SetValues Method

} //End employeeDataSource Class @2-FCB6E20C

class clsRecordemployee1 { //employee1 Class @23-BD315ADE
...
//Class_Initialize Event @23-D6A6336D
    function clsRecordemployee1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ConstantFactor = & new clsControl(ccsTextBox, "ConstantFactor", "Constant Factor", ccsSingle, "", CCGetRequestParam("ConstantFactor", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Initialize Method @23-AAA85980
    function Initialize()
    {
...
//Validate Method @23-33E6CF7F
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
        $Where = "";
        $Validation = ($this->ConstantFactor->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        $Validation =  $Validation && ($this->ConstantFactor->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @23-31C8A0D4
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->ConstantFactor->Errors->Count());
...
//InsertRow Method @23-6E4D4597
    function InsertRow()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeInsert", $this);
        if(!$this->InsertAllowed) return false;
        $this->DataSource->ConstantFactor->SetValue($this->ConstantFactor->GetValue(true));
...
//Show Method @23-EBFFA318
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            $Error = "";
            $Error = ComposeStrings($Error, $this->ConstantFactor->Errors->ToString());
...
} //End employee1 Class @23-FCB6E20C

class clsemployee1DataSource extends clsDBConnection1 {  //employee1DataSource Class @23-BDA765D5

//DataSource Variables @23-76E804F5
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @23-AE277450
    function clsemployee1DataSource(& $Parent)
    {
        ...
        $this->InsertFields["ConstantFactor"] = array("Name" => "ConstantFactor", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["ConstantFactor"] = array("Name" => "ConstantFactor", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event

//Prepare Method @23-E1300750
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Insert Method @23-4468BF27
    function Insert()
    {
        ...
        $this->InsertFields["ConstantFactor"]["Value"] = $this->ConstantFactor->GetDBValue(true);
...
//Update Method @23-C9E192DA
    function Update()
    {
        ...
        $this->UpdateFields["ConstantFactor"]["Value"] = $this->ConstantFactor->GetDBValue(true);
...
} //End employee1DataSource Class @23-FCB6E20C

//Initialize Page @1-EF45908E
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ConstantFactor.html";
$BlockToParse = "main";
...
$Link1->Page = "CurrentPosition.php";
