<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" connection="Connection1" dataSource="departmentoffice, employee, lut_statofappt2, lut_sex, lut_status" name="departmentoffice_employee1" orderBy="employee.Surname" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Statofappt2 " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			<Components>
				...
				<Section id="44" visible="True" lines="1" name="Detail">
					<Components>
						...
						<ReportLabel id="129" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel5" PathID="departmentoffice_employee1DetailReportLabel5" fieldSource="OrigApptMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="130" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel6" PathID="departmentoffice_employee1DetailReportLabel6" fieldSource="OrigApptDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="131" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel7" PathID="departmentoffice_employee1DetailReportLabel7" fieldSource="OrigApptYear">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="135" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="StatApp1" wizardCaption="StatApp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="departmentoffice_employee1DetailStatApp1" fieldSource="Status">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<JoinTables>
				...
				<JoinTable id="4" tableName="employee" posLeft="13" posTop="19" posWidth="146" posHeight="229"/>
				<JoinTable id="5" tableName="lut_statofappt2" posLeft="201" posTop="123" posWidth="103" posHeight="88"/>
				<JoinTable id="103" tableName="lut_sex" posLeft="219" posTop="247" posWidth="95" posHeight="88"/>
				<JoinTable id="137" tableName="lut_status" posLeft="314" posTop="164" posWidth="95" posHeight="88"/>
			</JoinTables>
			<JoinLinks>
				<JoinTable2 id="140" tableLeft="employee" tableRight="departmentoffice" fieldLeft="employee.OfficeID" fieldRight="departmentoffice.OfficeID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="141" tableLeft="employee" tableRight="lut_statofappt2" fieldLeft="employee.StatAppID" fieldRight="lut_statofappt2.StatAppID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="142" tableLeft="employee" tableRight="lut_sex" fieldLeft="employee.Sex" fieldRight="lut_sex.SexID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="143" tableLeft="employee" tableRight="lut_status" fieldLeft="employee.StatID" fieldRight="lut_status.StatID" joinType="left" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="132" tableName="employee" fieldName="OrigApptMonth"/>
				<Field id="133" tableName="employee" fieldName="OrigApptDay"/>
				<Field id="134" tableName="employee" fieldName="OrigApptYear"/>
				<Field id="136" tableName="employee" fieldName="employee.StatID" alias="employee_StatID"/>
				<Field id="139" tableName="lut_status" fieldName="lut_status.*"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
		...
		<Record id="24" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" PathID="departmentoffice_employee" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Link id="25" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="Query_EmpDepartmentNSPH.ccp" removeParameters="s_employee_OfficeID;s_Surname;s_FirstName;s_MiddleName;ListBox1;s_employee_Position;s_ItemNo;s_SalaryGrade;s_StepIncrement;CheckBoxList1;ListBox2;ListBox3;TextBox1" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Query_EmpDepartmentNSPH_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Query_EmpDepartmentNSPH.php" forShow="True" url="Query_EmpDepartmentNSPH.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
