<?php
//Include Common Files @1-298C2C60
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_emp_compensatnCOH_inactiveprint2.php");
...
//Open Method @2-F6046FA6
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, OrigApptMonth, OrigApptDay, OrigApptYear, MonthlySalary+2000.00+9500.00 AS Expr1,\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_emp_compensatnCOH_inactiveprint2.html";
$BlockToParse = "main";
...
//Include events file @1-FB9B88B7
include_once("./Cert_emp_compensatnCOH_inactiveprint2_events.php");
