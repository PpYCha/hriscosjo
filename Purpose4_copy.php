<?php
//Include Common Files @1-4024EDE3
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Purpose4_copy.php");
...
//Class_Initialize Event @2-006EB66B
    function clsGridemployee($RelativePath, & $Parent)
    {
        ...
        $this->Surname->Page = "Purpose4_copy.php";
        ...
        $this->employee_Insert->Page = "Purpose4_copy.php";
...
//Operation Method @38-C6AE8394
    function Operation()
    {
        ...
        $Redirect = "SRreport.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Purpose4_copy.html";
$BlockToParse = "main";
