...
<Field id="95" tableName="employee" fieldName="IssuedAt"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_emp_compensatnAPGDH_inactiveprint_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_emp_compensatnAPGDH_inactiveprint.php" forShow="True" url="Cert_emp_compensatnAPGDH_inactiveprint.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
