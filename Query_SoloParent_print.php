<?php
//Include Common Files @1-5B88D040
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_SoloParent_print.php");
...
//Class_Initialize Event @14-D7253EF6
...
//Operation Method @14-80A41BBF
    function Operation()
    {
        ...
        $Redirect = "Query_SoloParent_print.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Query_SoloParent_print.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_SoloParent_print.html";
$BlockToParse = "main";
...
//Include events file @1-67A26E82
include_once("./Query_SoloParent_print_events.php");
...
$Report_Print->Page = "Query_SoloParent_print.php";
