<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Print" sourceType="Table" returnValueType="Number" linesPerWebPage="40" connection="Connection1" dataSource="departmentoffice, employee, lut_servicerecpurpose" activeCollection="TableParameters" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Servicerecpurpose " wizardLayoutType="Tabular" pasteActions="pasteActions">
			...
			<JoinTables>
				...
				<JoinTable id="4" tableName="employee" posLeft="160" posTop="10" posWidth="160" posHeight="332"/>
			...
			<Fields>
				...
				<Field id="82" tableName="employee" fieldName="LastServiceMonth"/>
				<Field id="83" tableName="employee" fieldName="LastServiceDay"/>
				<Field id="84" tableName="employee" fieldName="LastService"/>
				<Field id="85" tableName="employee" fieldName="NameExtension"/>
				<Field id="90" tableName="employee" fieldName="ORNo"/>
				<Field id="91" tableName="employee" fieldName="IssuedOn"/>
				<Field id="92" tableName="employee" fieldName="IssuedAt"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_employment_inactiveelectedprint2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="Cert_employment_inactiveelectedprint2.php" forShow="True" url="Cert_employment_inactiveelectedprint2.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
