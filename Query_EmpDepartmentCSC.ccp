			...
			<Components>
				...
				<Section id="44" visible="True" lines="1" name="Detail">
					<Components>
						...
						<ReportLabel id="128" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel1" PathID="departmentoffice_employee1DetailReportLabel1">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="129" fieldSourceType="DBColumn" dataType="Date" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel5" PathID="departmentoffice_employee1DetailReportLabel5" fieldSource="BirthDate" format="mm/dd/yyyy">
<Components/>
<Events/>
<Attributes/>
<Features/>
</ReportLabel>
<ReportLabel id="130" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel6" PathID="departmentoffice_employee1DetailReportLabel6" fieldSource="Sex">
<Components/>
<Events/>
<Attributes/>
<Features/>
			...
			<Fields>
				...
				<Field id="131" tableName="employee" fieldName="employee.Sex" alias="employee_Sex"/>
<Field id="132" tableName="employee" fieldName="BirthDate"/>
</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
		...
		<Record id="24" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" PathID="departmentoffice_employee" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Link id="25" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="Query_EmpDepartmentCSC.ccp" removeParameters="s_employee_OfficeID;s_Surname;s_FirstName;s_MiddleName;ListBox1;s_employee_Position;s_ItemNo;s_SalaryGrade;s_StepIncrement;CheckBoxList1;ListBox2;ListBox3;TextBox1" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Query_EmpDepartmentCSC_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Query_EmpDepartmentCSC.php" forShow="True" url="Query_EmpDepartmentCSC.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
