<?php
//Include Common Files @1-1AB245AA
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QEmp_Distiction.php");
...
//employee_employee_recogni ReportGroup class @2-D1512648
class clsReportGroupemployee_employee_recogni {
    var $GroupType;
    var $mode; //1 - open, 2 - close
    var $Report_TotalRecords, $_Report_TotalRecordsAttributes;
    var $ReportLabel2, $_ReportLabel2Attributes;
    var $Recognition, $_RecognitionAttributes;
    ...
    function clsReportGroupemployee_employee_recogni(& $parent) {
        $this->Parent = & $parent;
        $this->Attributes = $this->Parent->Attributes->GetAsArray();
    }
    function SetControls($PrevGroup = "") {
        $this->ReportLabel2 = $this->Parent->ReportLabel2->Value;
        $this->Recognition = $this->Parent->Recognition->Value;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_RecognitionAttributes = $this->Parent->Recognition->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->Recognition = $Header->Recognition;
        $Header->_RecognitionAttributes = $this->_RecognitionAttributes;
        $this->Parent->Recognition->Value = $Header->Recognition;
        $this->Parent->Recognition->Attributes->RestoreFromArray($Header->_RecognitionAttributes);
...
//End employee_employee_recogni ReportGroup class

//employee_employee_recogni GroupsCollection class @2-64529AC9
class clsGroupsCollectionemployee_employee_recogni {
    var $Groups;
    ...
    function clsGroupsCollectionemployee_employee_recogni(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupemployee_employee_recogni($this->Parent);
    ...
    function RestoreValues() {
        ...
        $this->Parent->Recognition->Value = $this->Parent->Recognition->initialValue;
...
//End employee_employee_recogni GroupsCollection class

class clsReportemployee_employee_recogni { //employee_employee_recogni Class @2-2B57F82F

//employee_employee_recogni Variables @2-87F7EA53
...
//End employee_employee_recogni Variables

//Class_Initialize Event @2-11C0C6DF
    function clsReportemployee_employee_recogni($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "employee_employee_recogni";
        $this->Visible = True;
        $this->Parent = & $Parent;
        ...
        $this->DataSource = new clsemployee_employee_recogniDataSource($this);
        ...
        $this->Recognition = & new clsControl(ccsReportLabel, "Recognition", "Recognition", ccsText, "", "", $this);
...
//GetErrors Method @2-E18CEDC8
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->Recognition->Errors->ToString());
...
//Show Method @2-041585EF
    function Show()
    {
        ...
        $Groups = new clsGroupsCollectionemployee_employee_recogni($this);
        ...
        while($is_next_record) {
            ...
            $this->Recognition->SetValue($this->DataSource->Recognition->GetValue());
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["Recognition"] = $this->Recognition->Visible;
            ...
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->Recognition->SetValue($items[$i]->Recognition);
                        $this->Recognition->Attributes->RestoreFromArray($items[$i]->_RecognitionAttributes);
...
} //End employee_employee_recogni Class @2-FCB6E20C

class clsemployee_employee_recogniDataSource extends clsDBConnection1 {  //employee_employee_recogniDataSource Class @2-F4B193B0

//DataSource Variables @2-3B274EC6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-A01CCF43
    function clsemployee_employee_recogniDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report employee_employee_recogni";
        $this->Initialize();
        $this->ReportLabel2 = new clsField("ReportLabel2", ccsText, "");
        
        $this->Recognition = new clsField("Recognition", ccsText, "");
...
//SetOrder Method @2-4FAA814B
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "RecognitionID";
...
//Open Method @2-7D83C899
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT EmployeeIDNo, employee_recognition.*, Surname, FirstName, MiddleName, NameExtension, EmpPicture \n\n" .
        "FROM employee_recognition INNER JOIN employee ON\n\n" .
        "employee_recognition.EmployeeID = employee.EmployeeID {SQL_Where} {SQL_OrderBy}";
...
//SetValues Method @2-5E6206F7
    function SetValues()
    {
        $this->ReportLabel2->SetDBValue($this->f("EmpPicture"));
        $this->Recognition->SetDBValue($this->f("Recognition"));
...
} //End employee_employee_recogniDataSource Class @2-FCB6E20C

//Initialize Page @1-BCA32421
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QEmp_Distiction.html";
$BlockToParse = "main";
...
//Include events file @1-EF8E6447
include_once("./QEmp_Distiction_events.php");
...
// Controls
$employee_employee_recogni = & new clsReportemployee_employee_recogni("", $MainPage);
$Report_Print = & new clsControl(ccsLink, "Report_Print", "Report_Print", ccsText, "", CCGetRequestParam("Report_Print", ccsGet, NULL), $MainPage);
$Report_Print->Page = "QEmp_Distiction_print.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Q_Employee.php";
$MainPage->employee_employee_recogni = & $employee_employee_recogni;
$MainPage->Report_Print = & $Report_Print;
$MainPage->Link1 = & $Link1;
$Report_Print->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Report_Print->Parameters = CCAddParam($Report_Print->Parameters, "ViewMode", "Print");
$employee_employee_recogni->Initialize();
...
//Go to destination page @1-0AEE77E6
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConnection1->close();
    header("Location: " . $Redirect);
    unset($employee_employee_recogni);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-AFF77ED3
$employee_employee_recogni->Show();
$Report_Print->Show();
$Link1->Show();
$Tpl->block_path = "";
