<?php
//Include Common Files @1-CFB10DF2
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QReferences.php");
...
//employee_references ReportGroup class @2-515B1D1A
class clsReportGroupemployee_references {
    var $GroupType;
    ...
    function clsReportGroupemployee_references(& $parent) {
        $this->Parent = & $parent;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_Sorter_NameAttributes = $this->Parent->Sorter_Name->Attributes->GetAsArray();
        $this->_Sorter_AddressAttributes = $this->Parent->Sorter_Address->Attributes->GetAsArray();
        $this->_Sorter_TelNoAttributes = $this->Parent->Sorter_TelNo->Attributes->GetAsArray();
...
//End employee_references ReportGroup class

//employee_references GroupsCollection class @2-508D4358
class clsGroupsCollectionemployee_references {
    var $Groups;
    ...
    function clsGroupsCollectionemployee_references(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupemployee_references($this->Parent);
...
//End employee_references GroupsCollection class

class clsReportemployee_references { //employee_references Class @2-BA6EF828

//employee_references Variables @2-A7391149
    ...
    var $Sorter_Address;
    var $Sorter_TelNo;
//End employee_references Variables

//Class_Initialize Event @2-EB2B5F79
    function clsReportemployee_references($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->SorterName = CCGetParam("employee_referencesOrder", "");
        $this->SorterDirection = CCGetParam("employee_referencesDir", "");
        ...
        $this->Sorter_TelNo = & new clsSorter($this->ComponentName, "Sorter_TelNo", $FileName, $this);
...
//Show Method @2-C520832E
    function Show()
    {
        ...
        $Groups = new clsGroupsCollectionemployee_references($this);
...
//DataSource Variables @2-62B9EC95
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-9EA30C03
    function clsemployee_referencesDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report employee_references";
        $this->Initialize();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QReferences.html";
$BlockToParse = "main";
...
//Include events file @1-D1D53B57
include_once("./QReferences_events.php");
...
// Controls
$employee_references = & new clsReportemployee_references("", $MainPage);
...
//Go to destination page @1-29576BBC
if($Redirect)
{
