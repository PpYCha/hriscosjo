<?php
//Include Common Files @1-FE889E3D
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "CurrentPosition2.php");
...
//Class_Initialize Event @2-6E10C801
    function clsGridemployee($RelativePath, & $Parent)
    {
        ...
        $this->employee_Insert->Page = "CurrentPosition.php";
...
//Class_Initialize Event @33-0E5436DE
...
"FROM lut_month {SQL_Where} {SQL_OrderBy}";
            ...
            $this->ModeSeparatnID = & new clsControl(ccsListBox, "ModeSeparatnID", "Mode Separatn ID", ccsInteger, "", CCGetRequestParam("ModeSeparatnID", $Method, NULL), $this);
            $this->ModeSeparatnID->DSType = dsTable;
            $this->ModeSeparatnID->DataSource = new clsDBConnection1();
            $this->ModeSeparatnID->ds = & $this->ModeSeparatnID->DataSource;
            $this->ModeSeparatnID->DataSource->SQL = "SELECT * \n" .
"FROM lut_modeseparatn {SQL_Where} {SQL_OrderBy}";
            list($this->ModeSeparatnID->BoundColumn, $this->ModeSeparatnID->TextColumn, $this->ModeSeparatnID->DBFormat) = array("ModeSeparatnID", "ModeSeparatn", "");
            ...
            $this->DetailedDate = & new clsControl(ccsTextBox, "DetailedDate", "Detailed Date", ccsDate, $DefaultDateFormat, CCGetRequestParam("DetailedDate", $Method, NULL), $this);
...
"FROM lut_stepincrement {SQL_Where} {SQL_OrderBy}";
            ...
            $this->Link1->Page = "ConstantFactor.php";
        }
    }
//End Class_Initialize Event
...
//Validate Method @33-92A7A9CD
    function Validate()
    {
        ...
        $Validation = ($this->ModeSeparatnID->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->ModeSeparatnID->Errors->Count() == 0);
...
//CheckErrors Method @33-7550810C
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->ModeSeparatnID->Errors->Count());
...
//InsertRow Method @33-7B13D635
    function InsertRow()
    {
        ...
        $this->DataSource->ModeSeparatnID->SetValue($this->ModeSeparatnID->GetValue(true));
...
//Show Method @33-9C653496
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->ModeSeparatnID->SetValue($this->DataSource->ModeSeparatnID->GetValue());
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->ModeSeparatnID->Errors->ToString());
...
//DataSource Variables @33-E1231BDF
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @33-E82D761D
    function clsemployee1DataSource(& $Parent)
    {
        ...
        $this->ModeSeparatnID = new clsField("ModeSeparatnID", ccsInteger, "");
        ...
        $this->InsertFields["StatAppID"] = array("Name" => "StatAppID", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->InsertFields["ModeSeparatnID"] = array("Name" => "ModeSeparatnID", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["DetailedID"] = array("Name" => "DetailedID", "Value" => "", "DataType" => ccsInteger);
        $this->InsertFields["DetailedOffice"] = array("Name" => "DetailedOffice", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["DetailedDate"] = array("Name" => "DetailedDate", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["DetailedRemarks"] = array("Name" => "DetailedRemarks", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->InsertFields["LastService"] = array("Name" => "LastService", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//SetValues Method @33-64B9A3FA
    function SetValues()
    {
        ...
        $this->ModeSeparatnID->SetDBValue(trim($this->f("ModeSeparatnID")));
...
//Insert Method @33-A6E99CD7
    function Insert()
    {
        ...
        $this->InsertFields["StatAppID"]["Value"] = $this->StatAppt->GetDBValue(true);
        ...
        $this->InsertFields["ModeSeparatnID"]["Value"] = $this->ModeSeparatnID->GetDBValue(true);
        $this->InsertFields["DetailedID"]["Value"] = $this->DetailedID->GetDBValue(true);
        $this->InsertFields["DetailedOffice"]["Value"] = $this->DetailedOffice->GetDBValue(true);
        $this->InsertFields["DetailedDate"]["Value"] = $this->DetailedDate->GetDBValue(true);
        $this->InsertFields["DetailedRemarks"]["Value"] = $this->DetailedRemarks->GetDBValue(true);
        ...
        $this->InsertFields["LastService"]["Value"] = $this->LastService->GetDBValue(true);
...
//Update Method @33-B1824D51
    function Update()
    {
        ...
        $this->UpdateFields["ModeSeparatnID"]["Value"] = $this->ModeSeparatnID->GetDBValue(true);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "CurrentPosition2.html";
$BlockToParse = "main";
