<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Print" sourceType="Table" returnValueType="Number" linesPerWebPage="40" connection="Connection1" dataSource="departmentoffice, employee, lut_servicerecpurpose, lut_statofappt2" activeCollection="TableParameters" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Servicerecpurpose " wizardLayoutType="Tabular" pasteActions="pasteActions">
			<Components>
				...
				<Section id="34" visible="True" lines="1" name="Detail" pasteActions="pasteActions">
					<Components>
						...
						<Hidden id="73" fieldSourceType="DBColumn" dataType="Text" name="Hidden2" PathID="departmentoffice_employee1DetailHidden2" fieldSource="NameExtension">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="75" fieldSourceType="DBColumn" dataType="Text" name="Hidden3" PathID="departmentoffice_employee1DetailHidden3" fieldSource="ORNo">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="76" fieldSourceType="DBColumn" dataType="Date" name="Hidden4" PathID="departmentoffice_employee1DetailHidden4" fieldSource="IssuedOn" format="mmmm d, yyyy">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="77" fieldSourceType="DBColumn" dataType="Text" name="Hidden5" PathID="departmentoffice_employee1DetailHidden5" fieldSource="IssuedAt">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="85" fieldSourceType="DBColumn" dataType="Text" name="Hidden6" PathID="departmentoffice_employee1DetailHidden6" fieldSource="StatApp">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="86" fieldSourceType="DBColumn" dataType="Text" name="Hidden7" PathID="departmentoffice_employee1DetailHidden7" fieldSource="OrigApptMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="87" fieldSourceType="DBColumn" dataType="Text" name="Hidden8" PathID="departmentoffice_employee1DetailHidden8" fieldSource="OrigApptDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="88" fieldSourceType="DBColumn" dataType="Text" name="Hidden9" PathID="departmentoffice_employee1DetailHidden9" fieldSource="OrigApptYear">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="95" fieldSourceType="DBColumn" dataType="Text" name="Hidden10" PathID="departmentoffice_employee1DetailHidden10" fieldSource="LastServiceMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="96" fieldSourceType="DBColumn" dataType="Text" name="Hidden11" PathID="departmentoffice_employee1DetailHidden11" fieldSource="LastServiceDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="97" fieldSourceType="DBColumn" dataType="Text" name="Hidden12" PathID="departmentoffice_employee1DetailHidden12" fieldSource="LastService">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="99" fieldSourceType="DBColumn" dataType="Text" name="Hidden13" PathID="departmentoffice_employee1DetailHidden13" fieldSource="Rate">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="41" conditionType="Parameter" useIsNull="False" field="employee.Surname" parameterSource="s_Surname" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="1"/>
				<TableParameter id="42" conditionType="Parameter" useIsNull="False" field="employee.FirstName" parameterSource="s_FirstName" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="2"/>
				<TableParameter id="43" conditionType="Parameter" useIsNull="False" field="employee.MiddleInitial" parameterSource="s_MiddleInitial" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="3"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="3" tableName="departmentoffice" posLeft="10" posTop="10" posWidth="129" posHeight="180"/>
				<JoinTable id="4" tableName="employee" posLeft="160" posTop="10" posWidth="160" posHeight="340"/>
				<JoinTable id="6" tableName="lut_servicerecpurpose" posLeft="341" posTop="10" posWidth="128" posHeight="88"/>
				<JoinTable id="81" tableName="lut_statofappt2" posLeft="341" posTop="108" posWidth="113" posHeight="88"/>
			</JoinTables>
			<JoinLinks>
				...
				<JoinTable2 id="82" tableLeft="employee" tableRight="lut_statofappt2" fieldLeft="employee.StatAppID" fieldRight="lut_statofappt2.StatAppID" joinType="inner" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="74" tableName="employee" fieldName="NameExtension"/>
				<Field id="78" tableName="employee" fieldName="ORNo"/>
				<Field id="79" tableName="employee" fieldName="IssuedOn"/>
				<Field id="80" tableName="employee" fieldName="IssuedAt"/>
				<Field id="83" tableName="lut_statofappt2" fieldName="lut_statofappt2.*"/>
				<Field id="84" tableName="employee" fieldName="employee.StatAppID" alias="employee_StatAppID"/>
				<Field id="89" tableName="employee" fieldName="OrigApptMonth"/>
				<Field id="90" tableName="employee" fieldName="OrigApptDay"/>
				<Field id="91" tableName="employee" fieldName="OrigApptYear"/>
				<Field id="92" tableName="employee" fieldName="LastServiceMonth"/>
				<Field id="93" tableName="employee" fieldName="LastServiceDay"/>
				<Field id="94" tableName="employee" fieldName="LastService"/>
				<Field id="98" tableName="employee" fieldName="Rate"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_latestsalary_inactiveprintnoor_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_latestsalary_inactiveprintnoor.php" forShow="True" url="Cert_latestsalary_inactiveprintnoor.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
