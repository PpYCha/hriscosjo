...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_nopending_his_print2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_nopending_his_print2.php" forShow="True" url="Cert_nopending_his_print2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
