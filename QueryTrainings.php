<?php
//Include Common Files @1-DAE2BE02
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryTrainings.php");
...
//departmentoffice_employee1 ReportGroup class @2-B13B6CA1
...
//departmentoffice_employee1 GroupsCollection class @2-830FCC6D
...
//departmentoffice_employee1 Variables @2-8FB23FE8
...
//Class_Initialize Event @2-724EA18F
...
//Class_Initialize Event @11-ACD865FF
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "QueryTrainings.php";
...
//Operation Method @11-CA7F3CC5
    function Operation()
    {
        ...
        $Redirect = "QueryTrainings.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryTrainings.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryTrainings.html";
$BlockToParse = "main";
...
//Include events file @1-F295EF4C
include_once("./QueryTrainings_events.php");
...
$Report_Print->Page = "QueryTrainings.php";
