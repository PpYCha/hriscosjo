<?php
//Include Common Files @1-F73B60FE
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_Appearance.php");
...
//departmentoffice_employee1 ReportGroup class @2-EF228083
...
//departmentoffice_employee1 GroupsCollection class @2-63D99492
...
//Class_Initialize Event @2-5B24B347
...
//Open Method @2-F11903A1
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT NameOfficeDept, Surname, FirstName, MiddleInitial, employee.Position AS employee_Position, MonthlySalary, SalaryWords, CertDay,\n\n" .
        "CertMonth, CertYear, Title, NameExtension, AppearancePurpose \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_Appearance.html";
$BlockToParse = "main";
...
//Include events file @1-A8FAE4BB
include_once("./Cert_Appearance_events.php");
