<?php
//Include Common Files @1-6B2D1816
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryBirthdayprint2.php");
...
//departmentoffice_employee1 ReportGroup class @2-FB4062C5
...
//departmentoffice_employee1 GroupsCollection class @2-3E95F36B
...
//Class_Initialize Event @2-FC9F1A86
...
//DataSource Variables @2-A199B4A7
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-22E6CA5D
...
//Prepare Method @2-9DB4073E
    function Prepare()
    {
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "BirthMonth", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opEqual, "BirthDay", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opEqual, "BirthYear", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
...
//Class_Initialize Event @23-8C051A76
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_employee_OfficeID", "s_BirthMonth", "s_BirthDay", "s_BirthYear", "ccsForm"));
            $this->ClearParameters->Page = "QueryBirthdayprint2.php";
...
//CheckErrors Method @23-4B9FB1C5
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @23-9D966347
    function Operation()
    {
        ...
        $Redirect = "QueryBirthdayprint2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryBirthdayprint2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryBirthdayprint2.html";
$BlockToParse = "main";
...
//Include events file @1-E29117E7
include_once("./QueryBirthdayprint2_events.php");
...
$Report_Print->Page = "QueryBirthday_print.php";
