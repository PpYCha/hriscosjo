<?php
//Include Common Files @1-55E27290
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryCompulsory.php");
...
//Class_Initialize Event @25-47EEF268
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "QueryCompulsory.php";
...
//Operation Method @25-1F147AC4
    function Operation()
    {
        ...
        $Redirect = "QueryCompulsory.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryCompulsory.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryCompulsory.html";
$BlockToParse = "main";
...
//Include events file @1-64468F21
include_once("./QueryCompulsory_events.php");
...
$Report_Print->Page = "QueryCompulsory_printfinal.php";
