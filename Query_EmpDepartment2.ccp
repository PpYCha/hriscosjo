<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="100" connection="Connection1" dataSource="departmentoffice, employee, lut_statofappt2, lut_sex" name="departmentoffice_employee1" orderBy="employee.Surname" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Statofappt2 " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			...
			<JoinTables>
				<JoinTable id="3" tableName="departmentoffice" posLeft="331" posTop="79" posWidth="129" posHeight="198"/>
				<JoinTable id="4" tableName="employee" posLeft="13" posTop="19" posWidth="146" posHeight="304"/>
				<JoinTable id="5" tableName="lut_statofappt2" posLeft="198" posTop="109" posWidth="103" posHeight="88"/>
				<JoinTable id="103" tableName="lut_sex" posLeft="189" posTop="18" posWidth="95" posHeight="88"/>
			</JoinTables>
			<JoinLinks>
				<JoinTable2 id="122" tableLeft="employee" tableRight="departmentoffice" fieldLeft="employee.OfficeID" fieldRight="departmentoffice.OfficeID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="123" tableLeft="employee" tableRight="lut_statofappt2" fieldLeft="employee.StatAppID" fieldRight="lut_statofappt2.StatAppID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="124" tableLeft="employee" tableRight="lut_sex" fieldLeft="employee.Sex" fieldRight="lut_sex.SexID" joinType="left" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="125" tableName="employee" fieldName="employee.Position" alias="employee_Position"/>
<Field id="126" tableName="employee" fieldName="Surname"/>
<Field id="127" tableName="employee" fieldName="FirstName"/>
<Field id="128" tableName="employee" fieldName="MiddleName"/>
<Field id="129" tableName="employee" fieldName="MiddleInitial"/>
<Field id="130" tableName="employee" fieldName="NameExtension"/>
</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
		...
		<Record id="24" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" PathID="departmentoffice_employee" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Link id="25" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="Query_EmpDepartment2.ccp" removeParameters="s_employee_OfficeID;s_Surname;s_FirstName;s_MiddleName;ListBox1;s_employee_Position;s_ItemNo;s_SalaryGrade;s_StepIncrement;CheckBoxList1" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
		...
		<Link id="115" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" PathID="Link1" hrefSource="index.ccp" wizardUseTemplateBlock="False">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Query_EmpDepartment2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Query_EmpDepartment2.php" forShow="True" url="Query_EmpDepartment2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
