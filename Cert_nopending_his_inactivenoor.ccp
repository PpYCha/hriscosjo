<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Print" sourceType="Table" returnValueType="Number" linesPerWebPage="40" connection="Connection1" dataSource="departmentoffice, employee, lut_servicerecpurpose" activeCollection="TableParameters" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Servicerecpurpose " wizardLayoutType="Tabular" pasteActions="pasteActions">
			<Components>
				...
				<Section id="34" visible="True" lines="1" name="Detail">
					<Components>
						...
						<Hidden id="75" fieldSourceType="DBColumn" dataType="Text" name="Hidden3" PathID="departmentoffice_employee1DetailHidden3" fieldSource="Identity">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="77" fieldSourceType="DBColumn" dataType="Text" name="Hidden4" PathID="departmentoffice_employee1DetailHidden4" fieldSource="ORNo">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="78" fieldSourceType="DBColumn" dataType="Date" name="Hidden5" PathID="departmentoffice_employee1DetailHidden5" fieldSource="IssuedOn" format="mmmm d, yyyy">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="79" fieldSourceType="DBColumn" dataType="Text" name="Hidden6" PathID="departmentoffice_employee1DetailHidden6" fieldSource="IssuedAt">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<JoinTables>
				...
				<JoinTable id="4" tableName="employee" posLeft="160" posTop="10" posWidth="160" posHeight="310"/>
			...
			<Fields>
				...
				<Field id="76" tableName="employee" fieldName="Identity"/>
				<Field id="80" tableName="employee" fieldName="ORNo"/>
				<Field id="81" tableName="employee" fieldName="IssuedOn"/>
				<Field id="82" tableName="employee" fieldName="IssuedAt"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_nopending_his_inactivenoor_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="Cert_nopending_his_inactivenoor.php" forShow="True" url="Cert_nopending_his_inactivenoor.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
