<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" connection="Connection1" dataSource="departmentoffice, employee, lut_statofappt2, lut_sex" name="departmentoffice_employee1" orderBy="employee.Surname" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Statofappt2 " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			<Components>
				...
				<Section id="44" visible="True" lines="1" name="Detail" pasteActions="pasteActions">
					<Components>
						...
						<ReportLabel id="120" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="StatApp1" fieldSource="GsisBPN" wizardCaption="StatApp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="departmentoffice_employee1DetailStatApp1">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="121" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="StatApp2" fieldSource="PagIbigIDNo" wizardCaption="StatApp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="departmentoffice_employee1DetailStatApp2">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="122" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="StatApp3" fieldSource="PhilhealthNo" wizardCaption="StatApp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="departmentoffice_employee1DetailStatApp3">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="123" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="StatApp4" fieldSource="Tin" wizardCaption="StatApp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="departmentoffice_employee1DetailStatApp4">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="124" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="StatApp5" fieldSource="AgencyEmpNo" wizardCaption="StatApp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="departmentoffice_employee1DetailStatApp5">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="61" conditionType="Parameter" useIsNull="False" field="employee.SalaryGrade" dataType="Text" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="7" parameterSource="s_SalaryGrade"/>
				<TableParameter id="62" conditionType="Parameter" useIsNull="False" field="employee.StepIncrement" dataType="Text" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="8" parameterSource="s_StepIncrement"/>
			...
			<Fields>
				...
				<Field id="115" tableName="employee" fieldName="GsisBPN"/>
				<Field id="116" tableName="employee" fieldName="PagIbigIDNo"/>
				<Field id="117" tableName="employee" fieldName="PhilhealthNo"/>
				<Field id="118" tableName="employee" fieldName="Tin"/>
				<Field id="119" tableName="employee" fieldName="AgencyEmpNo"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
		...
		<Record id="24" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" PathID="departmentoffice_employee" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Link id="25" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="Query_EmpDepartment_PAcctO.ccp" removeParameters="s_employee_OfficeID;s_Surname;s_FirstName;s_MiddleName;ListBox1;s_employee_Position;s_ItemNo;s_SalaryGrade;s_StepIncrement;CheckBoxList1" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Query_EmpDepartment_PAcctO_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Query_EmpDepartment_PAcctO.php" forShow="True" url="Query_EmpDepartment_PAcctO.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
