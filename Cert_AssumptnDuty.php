<?php
//Include Common Files @1-4D13B2D7
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_AssumptnDuty.php");
...
//departmentoffice_employee1 ReportGroup class @2-A75FAB8E
...
//departmentoffice_employee1 GroupsCollection class @2-A9CE67C4
...
//Class_Initialize Event @2-C87D63B4
...
//DataSource Variables @2-84BE63ED
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-3ACB5379
...
//Prepare Method @2-B2306BF1
    function Prepare()
    {
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opBeginsWith, "employee.Surname", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opBeginsWith, "employee.FirstName", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
...
//Open Method @2-81BB9EF0
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT ServiceRecPurpose, Surname, FirstName, MiddleInitial, employee.Position AS employee_Position, MonthlySalary, SalaryWords, CertDay,\n\n" .
        "CertMonth, CertYear, Title, OrigApptMonth, OrigApptDay, OrigApptYear, MonthlySalary+2000.00 AS Expr1, NameExtension, EffectiveMonth,\n\n" .
        "EffectiveDay, EffectiveYear, departmentoffice.* \n\n" .
        "FROM (employee INNER JOIN lut_servicerecpurpose ON\n\n" .
        "employee.SecRecPurposeID = lut_servicerecpurpose.SecRecPurposeID) INNER JOIN departmentoffice ON\n\n" .
...
//SetValues Method @2-6AC7D05A
    function SetValues()
    {
        ...
        $this->Hidden3->SetDBValue($this->f("EffectiveDay"));
        $this->Hidden6->SetDBValue(trim($this->f("Expr1")));
        $this->Hidden5->SetDBValue($this->f("NameExtension"));
        $this->Hidden7->SetDBValue($this->f("NameOfficeHead"));
        $this->Hidden8->SetDBValue($this->f("Position"));
        $this->Hidden4->SetDBValue($this->f("EffectiveYear"));
        $this->Hidden2->SetDBValue($this->f("EffectiveMonth"));
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_AssumptnDuty.html";
$BlockToParse = "main";
...
//Include events file @1-78F49F54
include_once("./Cert_AssumptnDuty_events.php");
