<?php
//Include Common Files @1-815B0F2D
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QVolWork.php");
...
//employee_voluntaryworkinv ReportGroup class @2-54B72BF6
class clsReportGroupemployee_voluntaryworkinv {
    var $GroupType;
    ...
    function clsReportGroupemployee_voluntaryworkinv(& $parent) {
        $this->Parent = & $parent;
...
//End employee_voluntaryworkinv ReportGroup class

//employee_voluntaryworkinv GroupsCollection class @2-CCE2A93D
class clsGroupsCollectionemployee_voluntaryworkinv {
    var $Groups;
    ...
    function clsGroupsCollectionemployee_voluntaryworkinv(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupemployee_voluntaryworkinv($this->Parent);
...
//End employee_voluntaryworkinv GroupsCollection class

class clsReportemployee_voluntaryworkinv { //employee_voluntaryworkinv Class @2-1A297F1A

//employee_voluntaryworkinv Variables @2-87F7EA53
...
//End employee_voluntaryworkinv Variables

//Class_Initialize Event @2-975F3ABA
    function clsReportemployee_voluntaryworkinv($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
...
//Show Method @2-7D981DE1
    function Show()
    {
        ...
        $Groups = new clsGroupsCollectionemployee_voluntaryworkinv($this);
...
//DataSource Variables @2-5827CCCC
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-22D38C31
    function clsemployee_voluntaryworkinvDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report employee_voluntaryworkinv";
        $this->Initialize();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QVolWork.html";
$BlockToParse = "main";
...
//Include events file @1-7C474AC1
include_once("./QVolWork_events.php");
...
// Controls
$employee_voluntaryworkinv = & new clsReportemployee_voluntaryworkinv("", $MainPage);
...
//Go to destination page @1-3407B930
if($Redirect)
{
