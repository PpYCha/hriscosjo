<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="30" connection="Connection1" dataSource="employee_servicerecord" name="employee_servicerecord" orderBy="DateFrom, DateTo, AnnualSalary" pageSizeLimit="100" wizardCaption="List of Employee Servicerecord " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No records" activeCollection="TableParameters">
			<Components>
				<Link id="4" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="employee_servicerecord_Insert" hrefSource="ServiceRecord3.ccp" removeParameters="ServiceRecID" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="employee_servicerecordemployee_servicerecord_Insert">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<Link id="18" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="EmployeeID" fieldSource="EmployeeID" wizardCaption="Employee ID" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" hrefSource="ServiceRecord3.ccp" wizardThemeItem="GridA" PathID="employee_servicerecordEmployeeID">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="21" fieldSourceType="DBColumn" dataType="Date" html="False" name="DateFrom" fieldSource="DateFrom" wizardCaption="Date From" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="employee_servicerecordDateFrom" format="mm/dd/yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="63" fieldSourceType="DBColumn" dataType="Text" html="False" name="Label1" PathID="employee_servicerecordLabel1" fieldSource="Slash">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<JoinTables>
				<JoinTable id="57" tableName="employee_servicerecord" posLeft="10" posTop="10" posWidth="124" posHeight="292"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
				...
				<Field id="64" tableName="employee_servicerecord" fieldName="Slash"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<SecurityGroups/>
		...
		<Record id="39" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Connection1" name="employee_servicerecord1" dataSource="employee_servicerecord" errorSummator="Error" wizardCaption="Add/Edit Employee Servicerecord " wizardFormMethod="post" PathID="employee_servicerecord1" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				...
				<TextBox id="47" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="DateFrom" fieldSource="DateFrom" required="True" caption="Date From" wizardCaption="Date From" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1DateFrom" format="mm/dd/yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<DatePicker id="48" name="DatePicker_DateFrom" control="DateFrom" wizardSatellite="True" wizardControl="DateFrom" wizardDatePickerType="Image" wizardPicture="Styles/Fresh/Images/DatePicker.gif" style="Styles/Fresh/Style.css" PathID="employee_servicerecord1DatePicker_DateFrom">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</DatePicker>
				<TextBox id="50" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="Designation" fieldSource="Designation" required="False" caption="Designation" wizardCaption="Designation" wizardSize="50" wizardMaxLength="50" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1Designation">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="51" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="StatofAppt" fieldSource="StatofAppt" required="False" caption="Statof Appt" wizardCaption="Statof Appt" wizardSize="25" wizardMaxLength="25" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1StatofAppt">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="53" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="OfficeStatn" fieldSource="OfficeStatn" required="False" caption="Office Statn" wizardCaption="Office Statn" wizardSize="25" wizardMaxLength="25" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1OfficeStatn">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="54" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="Branch" fieldSource="Branch" required="False" caption="Branch" wizardCaption="Branch" wizardSize="25" wizardMaxLength="25" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1Branch">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="55" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="AbsenceWOPay" fieldSource="AbsenceWOPay" required="False" caption="Absence WOPay" wizardCaption="Absence WOPay" wizardSize="35" wizardMaxLength="35" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1AbsenceWOPay">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="56" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="Separation" fieldSource="Separation" required="False" caption="Separation" wizardCaption="Separation" wizardSize="35" wizardMaxLength="35" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1Separation">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="49" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="DateTo" fieldSource="DateTo" required="False" caption="Date To" wizardCaption="Date To" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee_servicerecord1DateTo">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="62" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="TextBox1" PathID="employee_servicerecord1TextBox1" fieldSource="Slash">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="ServiceRecord3_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="ServiceRecord3.php" forShow="True" url="ServiceRecord3.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
		<Group id="65" groupID="7"/>
		<Group id="66" groupID="6"/>
	</SecurityGroups>
	<CachingParameters/>
	<Attributes/>
	<Features/>
