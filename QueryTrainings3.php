<?php
//Include Common Files @1-338AF613
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryTrainings3.php");
...
//departmentoffice_employee1 ReportGroup class @2-7B716EFA
class clsReportGroupdepartmentoffice_employee1 {
    ...
    var $OfficeAcronym, $OfficeAcronymDup, $_OfficeAcronymAttributes;
    var $EmployeeIDNo, $EmployeeIDNoDup, $_EmployeeIDNoAttributes;
    var $Surname, $SurnameDup, $_SurnameAttributes;
    var $FirstName, $FirstNameDup, $_FirstNameAttributes;
    var $MiddleName, $MiddleNameDup, $_MiddleNameAttributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        if ($PrevGroup) {
            $this->OfficeAcronymDup =  CCCompareValues($this->OfficeAcronym, $PrevGroup->OfficeAcronym, $this->Parent->OfficeAcronym->DataType) == 0;
            $this->EmployeeIDNoDup =  CCCompareValues($this->EmployeeIDNo, $PrevGroup->EmployeeIDNo, $this->Parent->EmployeeIDNo->DataType) == 0;
            $this->SurnameDup =  CCCompareValues($this->Surname, $PrevGroup->Surname, $this->Parent->Surname->DataType) == 0;
            $this->FirstNameDup =  CCCompareValues($this->FirstName, $PrevGroup->FirstName, $this->Parent->FirstName->DataType) == 0;
            $this->MiddleNameDup =  CCCompareValues($this->MiddleName, $PrevGroup->MiddleName, $this->Parent->MiddleName->DataType) == 0;
        }
    }
...
class clsGroupsCollectiondepartmentoffice_employee1 {
    ...
    function clsGroupsCollectiondepartmentoffice_employee1(& $parent) {
        ...
        $this->mEmployeeIDNoCurrentHeaderIndex = 2;
        $this->mSurnameCurrentHeaderIndex = 3;
        $this->mFirstNameCurrentHeaderIndex = 4;
        $this->mMiddleNameCurrentHeaderIndex = 5;
    ...
    function & InitGroup() {
        ...
        $group->EmployeeIDNoTotalIndex = $this->mEmployeeIDNoCurrentHeaderIndex;
    ...
    function OpenGroup($groupName) {
        ...
        if ($groupName == "EmployeeIDNo" or $OpenFlag) {
            $GroupEmployeeIDNo = & $this->InitGroup(true);
            $this->Parent->EmployeeIDNo_Header->CCSEventResult = CCGetEvent($this->Parent->EmployeeIDNo_Header->CCSEvents, "OnInitialize", $this->Parent->EmployeeIDNo_Header);
            if ($this->Parent->Page_Footer->Visible) 
                $OverSize = $this->Parent->EmployeeIDNo_Header->Height + $this->Parent->Page_Footer->Height;
            else
                $OverSize = $this->Parent->EmployeeIDNo_Header->Height;
            if (($this->PageSize > 0) and $this->Parent->EmployeeIDNo_Header->Visible and ($this->CurrentPageSize + $OverSize > $this->PageSize)) {
                $this->ClosePage();
                $this->OpenPage();
            }
            if ($this->Parent->EmployeeIDNo_Header->Visible)
                $this->CurrentPageSize = $this->CurrentPageSize + $this->Parent->EmployeeIDNo_Header->Height;
                $GroupEmployeeIDNo->SetTotalControls("GetNextValue");
            $this->Parent->EmployeeIDNo_Header->CCSEventResult = CCGetEvent($this->Parent->EmployeeIDNo_Header->CCSEvents, "OnCalculate", $this->Parent->EmployeeIDNo_Header);
            $GroupEmployeeIDNo->SetControls();
            $GroupEmployeeIDNo->Mode = 1;
            $OpenFlag = true;
            $GroupEmployeeIDNo->GroupType = "EmployeeIDNo";
            $this->mEmployeeIDNoCurrentHeaderIndex = count($this->Groups);
            $this->Groups[] = & $GroupEmployeeIDNo;
        }
    ...
    function CloseGroup($groupName)
    {
        ...
        $GroupEmployeeIDNo = & $this->InitGroup(true);
        $this->Parent->EmployeeIDNo_Footer->CCSEventResult = CCGetEvent($this->Parent->EmployeeIDNo_Footer->CCSEvents, "OnInitialize", $this->Parent->EmployeeIDNo_Footer);
        if ($this->Parent->Page_Footer->Visible) 
            $OverSize = $this->Parent->EmployeeIDNo_Footer->Height + $this->Parent->Page_Footer->Height;
        else
            $OverSize = $this->Parent->EmployeeIDNo_Footer->Height;
        if (($this->PageSize > 0) and $this->Parent->EmployeeIDNo_Footer->Visible and ($this->CurrentPageSize + $OverSize > $this->PageSize)) {
            $this->ClosePage();
            $this->OpenPage();
        }
        $GroupEmployeeIDNo->SetTotalControls("GetPrevValue");
        $GroupEmployeeIDNo->SyncWithHeader($this->Groups[$this->mEmployeeIDNoCurrentHeaderIndex]);
        if ($this->Parent->EmployeeIDNo_Footer->Visible)
            $this->CurrentPageSize = $this->CurrentPageSize + $this->Parent->EmployeeIDNo_Footer->Height;
        $this->Parent->EmployeeIDNo_Footer->CCSEventResult = CCGetEvent($this->Parent->EmployeeIDNo_Footer->CCSEvents, "OnCalculate", $this->Parent->EmployeeIDNo_Footer);
        $GroupEmployeeIDNo->SetControls();
        $this->RestoreValues();
        $GroupEmployeeIDNo->Mode = 2;
        $GroupEmployeeIDNo->GroupType ="EmployeeIDNo";
        $this->Groups[] = & $GroupEmployeeIDNo;
        if ($groupName == "EmployeeIDNo") return;
        $GroupOfficeAcronym = & $this->InitGroup(true);
...
//departmentoffice_employee1 Variables @2-F05FE9BF
    ...
    var $EmployeeIDNo_HeaderBlock, $EmployeeIDNo_Header;
    var $EmployeeIDNo_FooterBlock, $EmployeeIDNo_Footer;
    ...
    var $EmployeeIDNo_HeaderControls, $EmployeeIDNo_FooterControls;
...
//Class_Initialize Event @2-7D1128D9
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->EmployeeIDNo_Footer = new clsSection($this);
        $this->EmployeeIDNo_Header = new clsSection($this);
...
//Show Method @2-B9E0C745
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            } elseif ($EmployeeIDNoKey != $this->DataSource->f("EmployeeIDNo")) {
                $Groups->OpenGroup("EmployeeIDNo");
            ...
            $EmployeeIDNoKey = $this->DataSource->f("EmployeeIDNo");
            ...
            if (!$is_next_record || $OfficeAcronymKey != $this->DataSource->f("OfficeAcronym")) {
                ...
                $Groups->CloseGroup("EmployeeIDNo");
            } elseif ($SurnameKey != $this->DataSource->f("Surname")) {
            ...
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->OfficeAcronym->Visible = $this->ControlsVisible["OfficeAcronym"] && !$items[$i]->OfficeAcronymDup;
                        ...
                        $this->EmployeeIDNo->Visible = $this->ControlsVisible["EmployeeIDNo"] && !$items[$i]->EmployeeIDNoDup;
                        ...
                        $this->Surname->Visible = $this->ControlsVisible["Surname"] && !$items[$i]->SurnameDup;
                        $this->Surname->SetValue($items[$i]->Surname);
                        $this->Surname->Attributes->RestoreFromArray($items[$i]->_SurnameAttributes);
                        $this->FirstName->Visible = $this->ControlsVisible["FirstName"] && !$items[$i]->FirstNameDup;
                        $this->FirstName->SetValue($items[$i]->FirstName);
                        $this->FirstName->Attributes->RestoreFromArray($items[$i]->_FirstNameAttributes);
                        $this->MiddleName->Visible = $this->ControlsVisible["MiddleName"] && !$items[$i]->MiddleNameDup;
                    ...
                    case "EmployeeIDNo":
                        if ($items[$i]->Mode == 1) {
                            $this->EmployeeIDNo_Header->CCSEventResult = CCGetEvent($this->EmployeeIDNo_Header->CCSEvents, "BeforeShow", $this->EmployeeIDNo_Header);
                            if ($this->EmployeeIDNo_Header->Visible) {
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock . "/Section EmployeeIDNo_Header";
                                $this->Attributes->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
                                $Tpl->parseto("Section EmployeeIDNo_Header", true, "Section Detail");
                            }
                        }
                        if ($items[$i]->Mode == 2) {
                            $this->EmployeeIDNo_Footer->CCSEventResult = CCGetEvent($this->EmployeeIDNo_Footer->CCSEvents, "BeforeShow", $this->EmployeeIDNo_Footer);
                            if ($this->EmployeeIDNo_Footer->Visible) {
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock . "/Section EmployeeIDNo_Footer";
                                $this->Attributes->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
                                $Tpl->parseto("Section EmployeeIDNo_Footer", true, "Section Detail");
                            }
                        }
                        break;
                    case "Surname":
...
//DataSource Variables @2-FA6FE579
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E0B8A800
...
//Open Method @2-89DA3D98
    function Open()
    {
        ...
        $this->query(CCBuildSQL($this->SQL, $this->Where, "departmentoffice.OfficeAcronym asc,employee.EmployeeIDNo asc,employee.Surname asc,employee.FirstName asc,employee.MiddleName asc" .  ($this->Order ? ", " . $this->Order: "")));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
    }
//End Open Method

//SetValues Method @2-9B5E47AF
    function SetValues()
    {
...
//Class_Initialize Event @11-34B809A2
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "QueryTrainings3.php";
...
"FROM lut_statofappt {SQL_Where} {SQL_OrderBy}";
            ...
            $this->s_TrainingCategory = & new clsControl(ccsListBox, "s_TrainingCategory", "s_TrainingCategory", ccsText, "", CCGetRequestParam("s_TrainingCategory", $Method, NULL), $this);
            $this->s_TrainingCategory->DSType = dsTable;
            $this->s_TrainingCategory->DataSource = new clsDBConnection1();
            $this->s_TrainingCategory->ds = & $this->s_TrainingCategory->DataSource;
            $this->s_TrainingCategory->DataSource->SQL = "SELECT * \n" .
"FROM lut_trainingcat {SQL_Where} {SQL_OrderBy}";
            list($this->s_TrainingCategory->BoundColumn, $this->s_TrainingCategory->TextColumn, $this->s_TrainingCategory->DBFormat) = array("TrainingCat", "TrainingCat", "");
...
//Operation Method @11-D1A4D171
    function Operation()
    {
        ...
        $Redirect = "QueryTrainings3.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryTrainings3.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @11-CF1558BA
    function Show()
    {
        ...
        $this->s_TrainingCategory->Prepare();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryTrainings3.html";
$BlockToParse = "main";
...
//Include events file @1-70459232
include_once("./QueryTrainings3_events.php");
...
$Report_Print->Page = "QueryTrainings3.php";
