<?php
//Include Common Files @1-A29BDF59
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_emp_compensatn_inactiveprint2.php");
...
//Open Method @2-1871AA02
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, OrigApptMonth, OrigApptDay, OrigApptYear, MonthlySalary+2000.00 AS Expr1,\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_emp_compensatn_inactiveprint2.html";
$BlockToParse = "main";
...
//Include events file @1-7656C9C9
include_once("./Cert_emp_compensatn_inactiveprint2_events.php");
