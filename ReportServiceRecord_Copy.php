<?php
//Include Common Files @1-1A8C3020
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ReportServiceRecord_Copy.php");
...
//employee_employee_service1 ReportGroup class @2-3344FE40
...
//Class_Initialize Event @2-88C64326
...
//Class_Initialize Event @11-83846B97
    function clsRecordemployee_employee_service($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "ReportServiceRecord_Copy.php";
...
//Operation Method @11-316412C0
    function Operation()
    {
        ...
        $Redirect = "ReportServiceRecord_Copy.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ReportServiceRecord_Copy.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ReportServiceRecord_Copy.html";
$BlockToParse = "main";
...
//Include events file @1-7E9C8AA7
include_once("./ReportServiceRecord_Copy_events.php");
...
$Report_Print->Page = "ReportServiceRecord_Copy.php";
