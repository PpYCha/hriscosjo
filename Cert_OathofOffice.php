<?php
//Include Common Files @1-F8DC425F
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_OathofOffice.php");
...
//departmentoffice_employee1 ReportGroup class @2-7F4DC5AA
...
//departmentoffice_employee1 GroupsCollection class @2-092909C0
...
//Class_Initialize Event @2-7B02FFDA
...
//DataSource Variables @2-AC49054F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-B33CB15E
...
//Open Method @2-603B2365
    function Open()
    {
        ...
        "NameExtension, EffectiveMonth, EffectiveDay, EffectiveYear \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_OathofOffice.html";
$BlockToParse = "main";
...
//Include events file @1-E37CA696
include_once("./Cert_OathofOffice_events.php");
