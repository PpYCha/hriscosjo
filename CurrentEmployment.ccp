<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Joyful" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Connection1" dataSource="employee" name="employee" pageSizeLimit="100" wizardCaption="List of Employee " wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="True" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No records" activeCollection="TableParameters">
			<Components>
				...
				<Link id="14" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="EmployeeID" fieldSource="EmployeeID" wizardCaption="ID" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" hrefSource="CurrentEmployment.ccp" wizardThemeItem="GridA" PathID="employeeEmployeeID">
					<Components/>
					<Events/>
					<LinkParameters>
			...
			<Events/>
			<TableParameters>
				<TableParameter id="101" conditionType="Parameter" useIsNull="False" field="EmployeeID" dataType="Integer" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="EmployeeID"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="100" tableName="employee" posLeft="10" posTop="10" posWidth="160" posHeight="180"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
		...
		<Record id="33" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Connection1" name="employee1" dataSource="employee" errorSummator="Error" wizardCaption="Add/Edit Employee " wizardFormMethod="post" PathID="employee1" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				...
				<ListBox id="48" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StatAppt" fieldSource="StatAppt" required="False" caption="Stat Appt" wizardCaption="Stat Appt" wizardSize="25" wizardMaxLength="25" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StatAppt" connection="Connection1" dataSource="lut_statofappt" boundColumn="StatAppt" textColumn="StatAppt">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="91" visible="Yes" fieldSourceType="DBColumn" dataType="Single" name="NosaSalary" fieldSource="NosaSalary" required="False" caption="Nosa Salary" wizardCaption="Nosa Salary" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee1NosaSalary">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="92" visible="Yes" fieldSourceType="DBColumn" dataType="Single" name="NosaTotal" fieldSource="NosaTotal" required="False" caption="Nosa Total" wizardCaption="Nosa Total" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee1NosaTotal">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="98" visible="Yes" fieldSourceType="DBColumn" dataType="Single" name="NosiSalary" fieldSource="NosiSalary" required="False" caption="Nosi Salary" wizardCaption="Nosi Salary" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee1NosiSalary">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="99" visible="Yes" fieldSourceType="DBColumn" dataType="Single" name="NosiTotal" fieldSource="NosiTotal" required="False" caption="Nosi Total" wizardCaption="Nosi Total" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="employee1NosiTotal">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="44" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="EffectiveYear" fieldSource="EffectiveYear" required="False" caption="Effective Year" wizardCaption="Effective Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1EffectiveYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="52" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="OrigApptYear" fieldSource="OrigApptYear" required="False" caption="Orig Appt Year" wizardCaption="Orig Appt Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1OrigApptYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="55" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="PromotedYear" fieldSource="PromotedYear" required="False" caption="Promoted Year" wizardCaption="Promoted Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1PromotedYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="58" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc1Year" fieldSource="StepInc1Year" required="False" caption="Step Inc1 Year" wizardCaption="Step Inc1 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc1Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="61" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc2Year" fieldSource="StepInc2Year" required="False" caption="Step Inc2 Year" wizardCaption="Step Inc2 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc2Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="64" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc3Year" fieldSource="StepInc3Year" required="False" caption="Step Inc3 Year" wizardCaption="Step Inc3 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc3Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="67" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc4Year" fieldSource="StepInc4Year" required="False" caption="Step Inc4 Year" wizardCaption="Step Inc4 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc4Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="70" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc5Year" fieldSource="StepInc5Year" required="False" caption="Step Inc5 Year" wizardCaption="Step Inc5 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc5Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="73" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc6Year" fieldSource="StepInc6Year" required="False" caption="Step Inc6 Year" wizardCaption="Step Inc6 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc6Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="76" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc7Year" fieldSource="StepInc7Year" required="False" caption="Step Inc7 Year" wizardCaption="Step Inc7 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc7Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="79" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="StepInc8Year" fieldSource="StepInc8Year" required="False" caption="Step Inc8 Year" wizardCaption="Step Inc8 Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1StepInc8Year">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="82" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="CompRetireYear" fieldSource="CompRetireYear" required="False" caption="Comp Retire Year" wizardCaption="Comp Retire Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1CompRetireYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="85" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="SeparationYear" fieldSource="SeparationYear" required="False" caption="Separation Year" wizardCaption="Separation Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1SeparationYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="88" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="NosaYear" fieldSource="NosaYear" required="False" caption="Nosa Year" wizardCaption="Nosa Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1NosaYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<TextBox id="95" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="NosiYear" fieldSource="NosiYear" required="False" caption="Nosi Year" wizardCaption="Nosi Year" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardEmptyCaption="Select Value" PathID="employee1NosiYear">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
		...
		<Link id="102" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" PathID="Link1" hrefSource="Employee.ccp" wizardUseTemplateBlock="False">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="CurrentEmployment.php" forShow="True" url="CurrentEmployment.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
