<?php
//Include Common Files @1-4CD59E43
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QChildren.php");
...
//employee_children ReportGroup class @2-0A744AF3
class clsReportGroupemployee_children {
    var $GroupType;
    ...
    function clsReportGroupemployee_children(& $parent) {
        $this->Parent = & $parent;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_Sorter_NameOfChildAttributes = $this->Parent->Sorter_NameOfChild->Attributes->GetAsArray();
        $this->_Sorter_DateOfBirthAttributes = $this->Parent->Sorter_DateOfBirth->Attributes->GetAsArray();
...
//End employee_children ReportGroup class

//employee_children GroupsCollection class @2-50C66A58
class clsGroupsCollectionemployee_children {
    var $Groups;
    ...
    function clsGroupsCollectionemployee_children(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupemployee_children($this->Parent);
...
//End employee_children GroupsCollection class

class clsReportemployee_children { //employee_children Class @2-30BD3E67

//employee_children Variables @2-3C45C695
    ...
    var $Sorter_NameOfChild;
    var $Sorter_DateOfBirth;
//End employee_children Variables

//Class_Initialize Event @2-ECF3D89E
    function clsReportemployee_children($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->SorterName = CCGetParam("employee_childrenOrder", "");
        $this->SorterDirection = CCGetParam("employee_childrenDir", "");
        ...
        $this->Sorter_NameOfChild = & new clsSorter($this->ComponentName, "Sorter_NameOfChild", $FileName, $this);
        $this->Sorter_DateOfBirth = & new clsSorter($this->ComponentName, "Sorter_DateOfBirth", $FileName, $this);
        $this->NameOfChild = & new clsControl(ccsReportLabel, "NameOfChild", "NameOfChild", ccsText, "", "", $this);
        $this->DateOfBirth = & new clsControl(ccsReportLabel, "DateOfBirth", "DateOfBirth", ccsDate, $DefaultDateFormat, "", $this);
...
//Show Method @2-AFA24044
    function Show()
    {
        ...
        $Groups = new clsGroupsCollectionemployee_children($this);
                    ...
                    case "Page":
                        if ($items[$i]->Mode == 1) {
                            ...
                            if ($this->Page_Header->Visible) {
                                ...
                                $this->Attributes->Show();
                                $this->Sorter_NameOfChild->Show();
                                $this->Sorter_DateOfBirth->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
...
//DataSource Variables @2-A0C47647
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-055339C7
    function clsemployee_childrenDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report employee_children";
        $this->Initialize();
...
//SetOrder Method @2-29319522
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "EmployeeChildID";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_NameOfChild" => array("NameOfChild", ""), 
            "Sorter_DateOfBirth" => array("DateOfBirth", "")));
    }
//End SetOrder Method
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QChildren.html";
$BlockToParse = "main";
...
//Include events file @1-73229105
include_once("./QChildren_events.php");
...
// Controls
$employee_children = & new clsReportemployee_children("", $MainPage);
...
//Go to destination page @1-288A0329
if($Redirect)
{
