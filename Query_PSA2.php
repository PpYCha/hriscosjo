<?php
//Include Common Files @1-67B712D3
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_PSA2.php");
...
//employee_departmentoffice ReportGroup class @2-5C3B7E88
class clsReportGroupemployee_departmentoffice {
    ...
    var $employee_MobileNo, $_employee_MobileNoAttributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->employee_MobileNo = $this->Parent->employee_MobileNo->Value;
    }
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_employee_MobileNoAttributes = $this->Parent->employee_MobileNo->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->employee_MobileNo = $Header->employee_MobileNo;
        $Header->_employee_MobileNoAttributes = $this->_employee_MobileNoAttributes;
        $this->Parent->employee_MobileNo->Value = $Header->employee_MobileNo;
        $this->Parent->employee_MobileNo->Attributes->RestoreFromArray($Header->_employee_MobileNoAttributes);
    }
...
//employee_departmentoffice GroupsCollection class @2-B6C30DE3
class clsGroupsCollectionemployee_departmentoffice {
    var $Groups;
    var $mPageCurrentHeaderIndex;
    var $mNameOfficeDeptCurrentHeaderIndex;
    var $PageSize;
    var $TotalPages = 0;
    var $TotalRows = 0;
    ...
    function clsGroupsCollectionemployee_departmentoffice(& $parent) {
        ...
        $this->Groups = array();
        $this->Pages  = array();
        $this->mNameOfficeDeptCurrentHeaderIndex = 1;
    ...
    function & InitGroup() {
        ...
        $group->NameOfficeDeptTotalIndex = $this->mNameOfficeDeptCurrentHeaderIndex;
        return $group;
    }
    ...
    function RestoreValues() {
        ...
        $this->Parent->employee_MobileNo->Value = $this->Parent->employee_MobileNo->initialValue;
    ...
    function OpenGroup($groupName) {
        ...
        if ($groupName == "NameOfficeDept") {
            $GroupNameOfficeDept = & $this->InitGroup(true);
            $this->Parent->NameOfficeDept_Header->CCSEventResult = CCGetEvent($this->Parent->NameOfficeDept_Header->CCSEvents, "OnInitialize", $this->Parent->NameOfficeDept_Header);
            if ($this->Parent->Page_Footer->Visible) 
                $OverSize = $this->Parent->NameOfficeDept_Header->Height + $this->Parent->Page_Footer->Height;
            else
                $OverSize = $this->Parent->NameOfficeDept_Header->Height;
            if (($this->PageSize > 0) and $this->Parent->NameOfficeDept_Header->Visible and ($this->CurrentPageSize + $OverSize > $this->PageSize)) {
                $this->ClosePage();
                $this->OpenPage();
            }
            if ($this->Parent->NameOfficeDept_Header->Visible)
                $this->CurrentPageSize = $this->CurrentPageSize + $this->Parent->NameOfficeDept_Header->Height;
                $GroupNameOfficeDept->SetTotalControls("GetNextValue");
            $this->Parent->NameOfficeDept_Header->CCSEventResult = CCGetEvent($this->Parent->NameOfficeDept_Header->CCSEvents, "OnCalculate", $this->Parent->NameOfficeDept_Header);
            $GroupNameOfficeDept->SetControls();
            $GroupNameOfficeDept->Mode = 1;
            $GroupNameOfficeDept->GroupType = "NameOfficeDept";
            $this->mNameOfficeDeptCurrentHeaderIndex = count($this->Groups);
            $this->Groups[] = & $GroupNameOfficeDept;
    ...
    function CloseGroup($groupName)
    {
        ...
        $GroupNameOfficeDept = & $this->InitGroup(true);
        $this->Parent->NameOfficeDept_Footer->CCSEventResult = CCGetEvent($this->Parent->NameOfficeDept_Footer->CCSEvents, "OnInitialize", $this->Parent->NameOfficeDept_Footer);
        if ($this->Parent->Page_Footer->Visible) 
            $OverSize = $this->Parent->NameOfficeDept_Footer->Height + $this->Parent->Page_Footer->Height;
        else
            $OverSize = $this->Parent->NameOfficeDept_Footer->Height;
        if (($this->PageSize > 0) and $this->Parent->NameOfficeDept_Footer->Visible and ($this->CurrentPageSize + $OverSize > $this->PageSize)) {
            $this->ClosePage();
            $this->OpenPage();
        }
        $GroupNameOfficeDept->SetTotalControls("GetPrevValue");
        $GroupNameOfficeDept->SyncWithHeader($this->Groups[$this->mNameOfficeDeptCurrentHeaderIndex]);
        if ($this->Parent->NameOfficeDept_Footer->Visible)
            $this->CurrentPageSize = $this->CurrentPageSize + $this->Parent->NameOfficeDept_Footer->Height;
        $this->Parent->NameOfficeDept_Footer->CCSEventResult = CCGetEvent($this->Parent->NameOfficeDept_Footer->CCSEvents, "OnCalculate", $this->Parent->NameOfficeDept_Footer);
        $GroupNameOfficeDept->SetControls();
        $this->Parent->Count_Surname->Reset();
        $this->RestoreValues();
        $GroupNameOfficeDept->Mode = 2;
        $GroupNameOfficeDept->GroupType ="NameOfficeDept";
        $this->Groups[] = & $GroupNameOfficeDept;
    }
...
//employee_departmentoffice Variables @2-895C3F33
    ...
    var $NameOfficeDept_HeaderBlock, $NameOfficeDept_Header;
    var $NameOfficeDept_FooterBlock, $NameOfficeDept_Footer;
    ...
    var $NameOfficeDept_HeaderControls, $NameOfficeDept_FooterControls;
//End employee_departmentoffice Variables

//Class_Initialize Event @2-D8D90C3B
    function clsReportemployee_departmentoffice($RelativePath = "", & $Parent)
    {
        ...
        $this->NameOfficeDept_Footer = new clsSection($this);
        $this->NameOfficeDept_Footer->Height = 1;
        $MaxSectionSize = max($MaxSectionSize, $this->NameOfficeDept_Footer->Height);
        $this->NameOfficeDept_Header = new clsSection($this);
        $this->NameOfficeDept_Header->Height = 1;
        $MaxSectionSize = max($MaxSectionSize, $this->NameOfficeDept_Header->Height);
        ...
        $this->NameOfficeDept->HTML = true;
        $this->NameOfficeDept->EmptyText = "&nbsp;";
        ...
        $this->employee_MobileNo = & new clsControl(ccsReportLabel, "employee_MobileNo", "employee_MobileNo", ccsText, "", "", $this);
        $this->employee_MobileNo->HTML = true;
        $this->employee_MobileNo->EmptyText = "&nbsp;";
        $this->Count_Surname = & new clsControl(ccsReportLabel, "Count_Surname", "Count_Surname", ccsInteger, "", 0, $this);
        $this->Count_Surname->HTML = true;
        $this->Count_Surname->TotalFunction = "Count";
        $this->Count_Surname->IsEmptySource = true;
        $this->Count_Surname->EmptyText = "&nbsp;";
...
//CheckErrors Method @2-43636C26
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->employee_MobileNo->Errors->Count());
...
//GetErrors Method @2-354629E7
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->employee_MobileNo->Errors->ToString());
...
//Show Method @2-CDC2BF21
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            $this->employee_MobileNo->SetValue($this->DataSource->employee_MobileNo->GetValue());
            ...
            if (count($Groups->Groups) == 2 or $NameOfficeDeptKey != $this->DataSource->f("NameOfficeDept")) {
                $Groups->OpenGroup("NameOfficeDept");
            }
            $Groups->AddItem();
            $NameOfficeDeptKey = $this->DataSource->f("NameOfficeDept");
            $is_next_record = $this->DataSource->next_record();
            if (!$is_next_record || $NameOfficeDeptKey != $this->DataSource->f("NameOfficeDept")) {
                $Groups->CloseGroup("NameOfficeDept");
            }
        }
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["employee_MobileNo"] = $this->employee_MobileNo->Visible;
            ...
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->employee_MobileNo->SetValue($items[$i]->employee_MobileNo);
                        $this->employee_MobileNo->Attributes->RestoreFromArray($items[$i]->_employee_MobileNoAttributes);
                    ...
                    case "NameOfficeDept":
                        if ($items[$i]->Mode == 1) {
                            ...
                            $this->NameOfficeDept_Header->CCSEventResult = CCGetEvent($this->NameOfficeDept_Header->CCSEvents, "BeforeShow", $this->NameOfficeDept_Header);
                            if ($this->NameOfficeDept_Header->Visible) {
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock . "/Section NameOfficeDept_Header";
                                $this->Attributes->Show();
                                $this->NameOfficeDept->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
                                $Tpl->parseto("Section NameOfficeDept_Header", true, "Section Detail");
                            }
                        }
                        if ($items[$i]->Mode == 2) {
                            ...
                            $this->NameOfficeDept_Footer->CCSEventResult = CCGetEvent($this->NameOfficeDept_Footer->CCSEvents, "BeforeShow", $this->NameOfficeDept_Footer);
                            if ($this->NameOfficeDept_Footer->Visible) {
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock . "/Section NameOfficeDept_Footer";
                                $this->Count_Surname->Show();
                                $this->Attributes->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
                                $Tpl->parseto("Section NameOfficeDept_Footer", true, "Section Detail");
                            }
                        }
                        break;
                }
...
//DataSource Variables @2-4A4E8858
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $ResProvince;
    var $ResZipcode;
    var $employee_MobileNo;
//End DataSource Variables

//DataSourceClass_Initialize Event @2-7E6D23F1
    function clsemployee_departmentofficeDataSource(& $Parent)
    {
        ...
        $this->employee_MobileNo = new clsField("employee_MobileNo", ccsText, "");
...
//Open Method @2-9898E980
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT NameOfficeDept, Surname, FirstName, MiddleName, ResHouseNo, ResStreet, ResSubVillage, ResBrgy, ResMunicipality, ResProvince,\n\n" .
        "ResZipcode, employee.MobileNo AS employee_MobileNo, employee.OfficeID AS employee_OfficeID \n\n" .
        ...
        $this->query(CCBuildSQL($this->SQL, $this->Where, "departmentoffice.NameOfficeDept asc" .  ($this->Order ? ", " . $this->Order: "")));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
    }
//End Open Method

//SetValues Method @2-3D3B8C6B
    function SetValues()
    {
        ...
        $this->employee_MobileNo->SetDBValue($this->f("employee_MobileNo"));
    }
...
//Class_Initialize Event @20-1D35F1B8
...
"FROM departmentoffice {SQL_Where} {SQL_OrderBy}";
            list($this->s_employee_OfficeID->BoundColumn, $this->s_employee_OfficeID->TextColumn, $this->s_employee_OfficeID->DBFormat) = array("OfficeID", "NameOfficeDept", "");
        }
    }
//End Class_Initialize Event

//Validate Method @20-11796C7B
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//CheckErrors Method @20-6C8F93EE
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @20-448547C6
    function Operation()
    {
        ...
        $Redirect = "Query_PSA2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Query_PSA2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_PSA2.html";
$BlockToParse = "main";
...
//Include events file @1-C45CC9F4
include_once("./Query_PSA2_events.php");
...
$Report_Print->Page = "Query_PSA2.php";
