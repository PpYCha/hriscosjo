<?php
//Include Common Files @1-E13BAB7C
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QEmp_Eligibility2.php");
...
//employee_employee_eligibi ReportGroup class @2-DAA3CE27
...
//employee_employee_eligibi GroupsCollection class @2-21B8B0BB
...
//employee_employee_eligibi Variables @2-87F7EA53
...
//Class_Initialize Event @2-F1021796
    function clsReportemployee_employee_eligibi($RelativePath = "", & $Parent)
    {
        ...
        $this->DateOfExam = & new clsControl(ccsReportLabel, "DateOfExam", "DateOfExam", ccsDate, array("mm", "/", "dd", "/", "yyyy"), "", $this);
        ...
        $this->DateOfValidity = & new clsControl(ccsReportLabel, "DateOfValidity", "DateOfValidity", ccsDate, array("mm", "/", "dd", "/", "yyyy"), "", $this);
...
//DataSource Variables @2-9520CBD0
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F50031D0
...
//Open Method @2-8BD64AF1
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT EmployeeIDNo, employee_eligibility.*, Surname, FirstName, MiddleName, NameExtension, EmpPicture \n\n" .
        "FROM employee_eligibility INNER JOIN employee ON\n\n" .
        "employee_eligibility.EmployeeID = employee.EmployeeID {SQL_Where} {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QEmp_Eligibility2.html";
$BlockToParse = "main";
...
//Include events file @1-5BF502A0
include_once("./QEmp_Eligibility2_events.php");
...
$Report_Print->Page = "QEmp_Eligibility2_print.php";
...
//Go to destination page @1-528A1C16
if($Redirect)
{
