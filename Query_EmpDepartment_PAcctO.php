<?php
//Include Common Files @1-576C5CC0
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpDepartment_PAcctO.php");
...
//departmentoffice_employee1 ReportGroup class @2-A4502C03
class clsReportGroupdepartmentoffice_employee1 {
    ...
    var $StatApp1, $_StatApp1Attributes;
    var $StatApp2, $_StatApp2Attributes;
    var $StatApp3, $_StatApp3Attributes;
    var $StatApp4, $_StatApp4Attributes;
    var $StatApp5, $_StatApp5Attributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->StatApp1 = $this->Parent->StatApp1->Value;
        $this->StatApp2 = $this->Parent->StatApp2->Value;
        $this->StatApp3 = $this->Parent->StatApp3->Value;
        $this->StatApp4 = $this->Parent->StatApp4->Value;
        $this->StatApp5 = $this->Parent->StatApp5->Value;
    }
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_StatApp1Attributes = $this->Parent->StatApp1->Attributes->GetAsArray();
        $this->_StatApp2Attributes = $this->Parent->StatApp2->Attributes->GetAsArray();
        $this->_StatApp3Attributes = $this->Parent->StatApp3->Attributes->GetAsArray();
        $this->_StatApp4Attributes = $this->Parent->StatApp4->Attributes->GetAsArray();
        $this->_StatApp5Attributes = $this->Parent->StatApp5->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->StatApp1 = $Header->StatApp1;
        $Header->_StatApp1Attributes = $this->_StatApp1Attributes;
        $this->Parent->StatApp1->Value = $Header->StatApp1;
        $this->Parent->StatApp1->Attributes->RestoreFromArray($Header->_StatApp1Attributes);
        $this->StatApp2 = $Header->StatApp2;
        $Header->_StatApp2Attributes = $this->_StatApp2Attributes;
        $this->Parent->StatApp2->Value = $Header->StatApp2;
        $this->Parent->StatApp2->Attributes->RestoreFromArray($Header->_StatApp2Attributes);
        $this->StatApp3 = $Header->StatApp3;
        $Header->_StatApp3Attributes = $this->_StatApp3Attributes;
        $this->Parent->StatApp3->Value = $Header->StatApp3;
        $this->Parent->StatApp3->Attributes->RestoreFromArray($Header->_StatApp3Attributes);
        $this->StatApp4 = $Header->StatApp4;
        $Header->_StatApp4Attributes = $this->_StatApp4Attributes;
        $this->Parent->StatApp4->Value = $Header->StatApp4;
        $this->Parent->StatApp4->Attributes->RestoreFromArray($Header->_StatApp4Attributes);
        $this->StatApp5 = $Header->StatApp5;
        $Header->_StatApp5Attributes = $this->_StatApp5Attributes;
        $this->Parent->StatApp5->Value = $Header->StatApp5;
        $this->Parent->StatApp5->Attributes->RestoreFromArray($Header->_StatApp5Attributes);
    }
...
//departmentoffice_employee1 GroupsCollection class @2-3A4C112C
class clsGroupsCollectiondepartmentoffice_employee1 {
    ...
    function RestoreValues() {
        ...
        $this->Parent->StatApp1->Value = $this->Parent->StatApp1->initialValue;
        $this->Parent->StatApp2->Value = $this->Parent->StatApp2->initialValue;
        $this->Parent->StatApp3->Value = $this->Parent->StatApp3->initialValue;
        $this->Parent->StatApp4->Value = $this->Parent->StatApp4->initialValue;
        $this->Parent->StatApp5->Value = $this->Parent->StatApp5->initialValue;
    }
...
//Class_Initialize Event @2-91C0112F
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->StatApp1 = & new clsControl(ccsReportLabel, "StatApp1", "StatApp1", ccsText, "", "", $this);
        $this->StatApp2 = & new clsControl(ccsReportLabel, "StatApp2", "StatApp2", ccsText, "", "", $this);
        $this->StatApp3 = & new clsControl(ccsReportLabel, "StatApp3", "StatApp3", ccsText, "", "", $this);
        $this->StatApp4 = & new clsControl(ccsReportLabel, "StatApp4", "StatApp4", ccsText, "", "", $this);
        $this->StatApp5 = & new clsControl(ccsReportLabel, "StatApp5", "StatApp5", ccsText, "", "", $this);
...
//CheckErrors Method @2-FDD0FDA2
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->StatApp1->Errors->Count());
        $errors = ($errors || $this->StatApp2->Errors->Count());
        $errors = ($errors || $this->StatApp3->Errors->Count());
        $errors = ($errors || $this->StatApp4->Errors->Count());
        $errors = ($errors || $this->StatApp5->Errors->Count());
...
//GetErrors Method @2-975F4076
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->StatApp1->Errors->ToString());
        $errors = ComposeStrings($errors, $this->StatApp2->Errors->ToString());
        $errors = ComposeStrings($errors, $this->StatApp3->Errors->ToString());
        $errors = ComposeStrings($errors, $this->StatApp4->Errors->ToString());
        $errors = ComposeStrings($errors, $this->StatApp5->Errors->ToString());
...
//Show Method @2-FDAD71D2
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            $this->StatApp1->SetValue($this->DataSource->StatApp1->GetValue());
            $this->StatApp2->SetValue($this->DataSource->StatApp2->GetValue());
            $this->StatApp3->SetValue($this->DataSource->StatApp3->GetValue());
            $this->StatApp4->SetValue($this->DataSource->StatApp4->GetValue());
            $this->StatApp5->SetValue($this->DataSource->StatApp5->GetValue());
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["StatApp1"] = $this->StatApp1->Visible;
            $this->ControlsVisible["StatApp2"] = $this->StatApp2->Visible;
            $this->ControlsVisible["StatApp3"] = $this->StatApp3->Visible;
            $this->ControlsVisible["StatApp4"] = $this->StatApp4->Visible;
            $this->ControlsVisible["StatApp5"] = $this->StatApp5->Visible;
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->StatApp1->SetValue($items[$i]->StatApp1);
                        $this->StatApp1->Attributes->RestoreFromArray($items[$i]->_StatApp1Attributes);
                        $this->StatApp2->SetValue($items[$i]->StatApp2);
                        $this->StatApp2->Attributes->RestoreFromArray($items[$i]->_StatApp2Attributes);
                        $this->StatApp3->SetValue($items[$i]->StatApp3);
                        $this->StatApp3->Attributes->RestoreFromArray($items[$i]->_StatApp3Attributes);
                        $this->StatApp4->SetValue($items[$i]->StatApp4);
                        $this->StatApp4->Attributes->RestoreFromArray($items[$i]->_StatApp4Attributes);
                        $this->StatApp5->SetValue($items[$i]->StatApp5);
                        $this->StatApp5->Attributes->RestoreFromArray($items[$i]->_StatApp5Attributes);
...
//DataSource Variables @2-A4E25AC9
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-97F35B8A
    function clsdepartmentoffice_employee1DataSource(& $Parent)
    {
        ...
        $this->StatApp1 = new clsField("StatApp1", ccsText, "");
        
        $this->StatApp2 = new clsField("StatApp2", ccsText, "");
        
        $this->StatApp3 = new clsField("StatApp3", ccsText, "");
        
        $this->StatApp4 = new clsField("StatApp4", ccsText, "");
        
        $this->StatApp5 = new clsField("StatApp5", ccsText, "");
...
//Prepare Method @2-71EF352B
    function Prepare()
    {
        ...
        $this->wp->Criterion[7] = $this->wp->Operation(opEqual, "employee.SalaryGrade", $this->wp->GetDBValue("7"), $this->ToSQL($this->wp->GetDBValue("7"), ccsText),false);
        $this->wp->Criterion[8] = $this->wp->Operation(opEqual, "employee.StepIncrement", $this->wp->GetDBValue("8"), $this->ToSQL($this->wp->GetDBValue("8"), ccsText),false);
...
//Open Method @2-815EBD8B
    function Open()
    {
        ...
        "lut_sex.*, GsisBPN, PagIbigIDNo, PhilhealthNo, Tin, AgencyEmpNo \n\n" .
...
//SetValues Method @2-88E37980
    function SetValues()
    {
        ...
        $this->StatApp1->SetDBValue($this->f("GsisBPN"));
        $this->StatApp2->SetDBValue($this->f("PagIbigIDNo"));
        $this->StatApp3->SetDBValue($this->f("PhilhealthNo"));
        $this->StatApp4->SetDBValue($this->f("Tin"));
        $this->StatApp5->SetDBValue($this->f("AgencyEmpNo"));
    }
...
//Class_Initialize Event @24-E292C106
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_employee_OfficeID", "s_Surname", "s_FirstName", "s_MiddleName", "ListBox1", "s_employee_Position", "s_ItemNo", "s_SalaryGrade", "s_StepIncrement", "CheckBoxList1", "ccsForm"));
            $this->ClearParameters->Page = "Query_EmpDepartment_PAcctO.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpDepartment_PAcctO.html";
$BlockToParse = "main";
...
//Include events file @1-8C37A973
include_once("./Query_EmpDepartment_PAcctO_events.php");
