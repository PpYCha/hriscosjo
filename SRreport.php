<?php
//Include Common Files @1-1F4BEB99
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "SRreport.php");
...
//employee_lut_servicerecpu ReportGroup class @2-454E88A8
...
//employee_lut_servicerecpu GroupsCollection class @2-46775757
...
//Class_Initialize Event @2-85257697
...
//Prepare Method @2-8397EA87
    function Prepare()
    {
        ...
        $this->wp->AddParameter("6", "urlEmployeeID", ccsInteger, "", "", $this->Parameters["urlEmployeeID"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "Surname", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "FirstName", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opEqual, "MiddleName", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opEqual, "NameExtension", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
        ...
        $this->wp->Criterion[6] = $this->wp->Operation(opEqual, "employee.EmployeeID", $this->wp->GetDBValue("6"), $this->ToSQL($this->wp->GetDBValue("6"), ccsInteger),false);
...
//Open Method @2-BD81B1C6
    function Open()
    {
        ...
        "lut_servicerecpurpose.*, employee_servicerecord.*, OfficeID, employee.EmployeeID AS employee_EmployeeID, CertDay, CertMonth,\n\n" .
        "CertYear \n\n" .
        "FROM (employee INNER JOIN employee_servicerecord ON\n\n" .
        "employee_servicerecord.EmployeeID = employee.EmployeeID) INNER JOIN lut_servicerecpurpose ON\n\n" .
...
class clsRecordemployee_employee_service { //employee_employee_service Class @20-6C0CC55F
...
//Class_Initialize Event @20-D64707CA
    function clsRecordemployee_employee_service($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_Surname", "s_FirstName", "s_MiddleName", "s_NameExtension", "s_OfficeID", "ccsForm"));
            $this->ClearParameters->Page = "SRreport.php";
            ...
            $this->Link3->Page = "Purpose4_copy.php";
        }
    }
//End Class_Initialize Event

//Validate Method @20-554AF7CD
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//CheckErrors Method @20-A0006A4E
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @20-A900B5DC
    function Operation()
    {
        ...
        $Redirect = "SRreport.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SRreport.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End employee_employee_service Class @20-FCB6E20C

//Initialize Page @1-FCAC2738
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SRreport.html";
$BlockToParse = "main";
...
//Authenticate User @1-87405C81
CCSecurityRedirect("7;6;2", "");
//End Authenticate User

//Include events file @1-64B85929
include_once("./SRreport_events.php");
...
$Report_Print1->Page = "SRreport_ms_backup3_2c.php";
...
//Go to destination page @1-30411561
if($Redirect)
{
