<?php
//Include Common Files @1-BB17917D
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Purpose4_certappearance.php");
...
//Class_Initialize Event @2-11CD18D7
    function clsGridemployee($RelativePath, & $Parent)
    {
        ...
        $this->Surname->Page = "Purpose4_certappearance.php";
        ...
        $this->employee_Insert->Page = "Purpose4_certappearance.php";
...
//Prepare Method @2-AB65C13A
    function Prepare()
    {
        ...
        $this->wp->AddParameter("3", "urls_MiddleInitial", ccsText, "", "", $this->Parameters["urls_MiddleInitial"], "", false);
        $this->wp->AddParameter("4", "urlEmployeeID", ccsInteger, "", "", $this->Parameters["urlEmployeeID"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "employee.Surname", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "employee.FirstName", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opEqual, "employee.MiddleInitial", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
...
//Open Method @2-C5F71AC9
    function Open()
    {
        ...
        $this->SQL = "SELECT EmployeeID, Surname, FirstName, MiddleName, CertDay, CertMonth, CertYear, lut_servicerecpurpose.*, AppearancePurpose \n\n" .
        "FROM employee LEFT JOIN lut_servicerecpurpose ON\n\n" .
...
//SetValues Method @2-46F52E9B
    function SetValues()
    {
        ...
        $this->SecRecPurposeID->SetDBValue($this->f("AppearancePurpose"));
...
//Class_Initialize Event @38-699EDB77
...
//CheckErrors Method @38-AF827939
...
//DataSource Variables @38-46B523B4
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @38-4E48BCB5
...
//SetValues Method @38-887B9916
    function SetValues()
    {
        $this->CertDay->SetDBValue($this->f("CertDay"));
        $this->CertMonth->SetDBValue($this->f("CertMonth"));
        $this->CertYear->SetDBValue($this->f("CertYear"));
        $this->TextBox1->SetDBValue($this->f("AppearancePurpose"));
    }
//End SetValues Method

//Insert Method @38-799DDB9C
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["AppearancePurpose"]["Value"] = $this->TextBox1->GetDBValue(true);
...
//Update Method @38-9C3D2566
    function Update()
    {
        ...
        $this->UpdateFields["AppearancePurpose"]["Value"] = $this->TextBox1->GetDBValue(true);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Purpose4_certappearance.html";
$BlockToParse = "main";
