<?php
//Include Common Files @1-3862C848
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary3.php");
...
//Class_Initialize Event @22-4BADC2C3
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary3.php";
...
//Operation Method @22-87258BB9
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary3.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary3.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary3.html";
$BlockToParse = "main";
...
//Include events file @1-14E48D5C
include_once("./Cert_latestsalary3_events.php");
...
$Link10->Page = "Cert_latestsalary_death.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_death.php";
