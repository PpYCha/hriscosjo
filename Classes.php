...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    ...
    $this->Messages["text1"] = "((VLEarned+VLPrevBalance)-VLAbsenceUndertWpay)";
    $this->Messages["text2"] = "((VLEarned+VLPrevBalance)-VLAbsenceUndertWpay)";
    $this->IsLoaded = true;
  }
