<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		...
		<Link id="70" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link5" PathID="Link5" wizardUseTemplateBlock="False" hrefSource="Cert_employment_casual.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
		...
		<Link id="71" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link6" PathID="Link6" wizardUseTemplateBlock="False" hrefSource="Cert_emp_compensatn_casual.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
		...
		<Link id="74" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" PathID="Link1" wizardUseTemplateBlock="False" hrefSource="Cert_nopending_casual.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
		...
		<Link id="92" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link2" PathID="Link2" wizardUseTemplateBlock="False" hrefSource="Cert_employment_casual2.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_latestsalary4_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_latestsalary4.php" forShow="True" url="Cert_latestsalary4.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
