<?php
//Include Common Files @1-6DA1CFC5
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpDepartment_print.php");
...
//departmentoffice_employee1 ReportGroup class @2-CA4E5F10
...
//departmentoffice_employee1 GroupsCollection class @2-BEC45337
...
//Class_Initialize Event @2-5AF97001
...
//DataSource Variables @2-0C1DF2D1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E314D223
...
//SetValues Method @2-369E129D
    function SetValues()
    {
        ...
        $this->ReportLabel1->SetDBValue($this->f("EffectiveMonth"));
        $this->ReportLabel2->SetDBValue($this->f("EffectiveDay"));
        $this->ReportLabel3->SetDBValue($this->f("EffectiveYear"));
    }
...
//Class_Initialize Event @24-DB500F86
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Query_EmpDepartment_print.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpDepartment_print.html";
$BlockToParse = "main";
...
//Include events file @1-7D3D2221
include_once("./Query_EmpDepartment_print_events.php");
