<?php
//Include Common Files @1-50E248A7
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary4.php");
...
//Class_Initialize Event @22-91C27C50
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary4.php";
...
//Operation Method @22-C1D4A43D
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary4.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary4.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary4.html";
$BlockToParse = "main";
...
//Include events file @1-8FE58246
include_once("./Cert_latestsalary4_events.php");
...
$Link5->Page = "Cert_employment_casual.php";
...
$Link6->Page = "Cert_emp_compensatn_casual.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_casual.php";
...
$Link2->Page = "Cert_employment_casual2.php";
