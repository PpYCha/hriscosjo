<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" connection="Connection1" dataSource="departmentoffice, employee, lut_statofappt2, lut_sex" name="departmentoffice_employee1" orderBy="employee.Surname" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Statofappt2 " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			<Components>
				...
				<Section id="44" visible="True" lines="1" name="Detail">
					<Components>
						...
						<ReportLabel id="110" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel1" PathID="departmentoffice_employee1DetailReportLabel1" fieldSource="BirthDate">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="111" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel2" PathID="departmentoffice_employee1DetailReportLabel2" fieldSource="PermMunicipality">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="115" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel3" PathID="departmentoffice_employee1DetailReportLabel3" fieldSource="EffectiveMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="116" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel4" PathID="departmentoffice_employee1DetailReportLabel4" fieldSource="EffectiveDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="117" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel5" PathID="departmentoffice_employee1DetailReportLabel5" fieldSource="EffectiveYear">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="60" conditionType="Parameter" useIsNull="False" field="employee.ItemNo" parameterSource="s_ItemNo" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="6"/>
				<TableParameter id="61" conditionType="Parameter" useIsNull="False" field="employee.SalaryGrade" parameterSource="s_SalaryGrade" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="7"/>
				<TableParameter id="62" conditionType="Parameter" useIsNull="False" field="employee.StepIncrement" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="8" parameterSource="s_StepIncrement"/>
			...
			<JoinTables>
				...
				<JoinTable id="5" tableName="lut_statofappt2" posLeft="199" posTop="185" posWidth="103" posHeight="88"/>
				<JoinTable id="103" tableName="lut_sex" posLeft="227" posTop="261" posWidth="95" posHeight="88"/>
			</JoinTables>
			<JoinLinks>
			...
			<Fields>
				...
				<Field id="16" tableName="employee" fieldName="ItemNo"/>
				<Field id="17" tableName="employee" fieldName="SalaryGrade"/>
				<Field id="18" tableName="employee" fieldName="StepIncrement"/>
				...
				<Field id="108" tableName="employee" fieldName="BirthDate"/>
				<Field id="109" tableName="employee" fieldName="PermMunicipality"/>
				<Field id="112" tableName="employee" fieldName="EffectiveMonth"/>
				<Field id="113" tableName="employee" fieldName="EffectiveDay"/>
				<Field id="114" tableName="employee" fieldName="EffectiveYear"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
		...
		<Record id="24" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" PathID="departmentoffice_employee" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Link id="25" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="Query_EmpDepartment_pgo.ccp" removeParameters="s_employee_OfficeID;s_Surname;s_FirstName;s_MiddleName;s_employee_Position;s_ItemNo;s_SalaryGrade;s_StepIncrement;s_employee_StatAppID" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<TextBox id="32" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="s_ItemNo" wizardCaption="Item No" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" PathID="departmentoffice_employees_ItemNo">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<ListBox id="33" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="s_SalaryGrade" wizardCaption="Salary Grade" wizardSize="2" wizardMaxLength="2" wizardIsPassword="False" wizardEmptyCaption="Select Value" PathID="departmentoffice_employees_SalaryGrade" connection="Connection1" dataSource="lut_salarygrade" boundColumn="SalaryGrade" textColumn="SalaryGrade" unique="True">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Query_EmpDepartment_pgo_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Query_EmpDepartment_pgo.php" forShow="True" url="Query_EmpDepartment_pgo.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
		<Group id="93" groupID="5"/>
		<Group id="94" groupID="4"/>
