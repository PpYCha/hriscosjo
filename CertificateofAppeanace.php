<?php
//Include Common Files @1-AA1184A0
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "CertificateofAppeanace.php");
...
//Class_Initialize Event @22-BB83C70A
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "CertificateofAppeanace.php";
            ...
            $this->Link4->Page = "Purpose4_certappearance.php";
            $this->Link5 = & new clsControl(ccsLink, "Link5", "Link5", ccsText, "", CCGetRequestParam("Link5", $Method, NULL), $this);
            $this->Link5->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
            $this->Link5->Page = "Purpose4_certappearance2.php";
        }
    }
//End Class_Initialize Event
...
//CheckErrors Method @22-BD0DEB26
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-9C319DEE
    function Operation()
    {
        ...
        $Redirect = "CertificateofAppeanace.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "CertificateofAppeanace.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @22-8BE8961B
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->Link5->Errors->ToString());
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "CertificateofAppeanace.html";
$BlockToParse = "main";
...
//Include events file @1-56D2267F
include_once("./CertificateofAppeanace_events.php");
...
$Link10->Page = "Cert_Appearance.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_Appearance2.php";
