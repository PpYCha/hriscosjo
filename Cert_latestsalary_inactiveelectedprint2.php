<?php
//Include Common Files @1-6B2394EF
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary_inactiveelectedprint2.php");
...
//departmentoffice_employee1 ReportGroup class @2-71F1E6AD
...
//departmentoffice_employee1 GroupsCollection class @2-73EB9BBC
...
//Class_Initialize Event @2-E557CD03
...
//DataSource Variables @2-E6BF879D
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-751F4E93
...
//Open Method @2-07AABADD
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, NameExtension, ORNo, IssuedOn, IssuedAt \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary_inactiveelectedprint2.html";
$BlockToParse = "main";
...
//Include events file @1-CFD271B9
include_once("./Cert_latestsalary_inactiveelectedprint2_events.php");
