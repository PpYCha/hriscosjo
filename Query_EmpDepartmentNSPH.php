<?php
//Include Common Files @1-CAB5DF05
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpDepartmentNSPH.php");
...
//departmentoffice_employee1 ReportGroup class @2-03BDF52B
...
//departmentoffice_employee1 GroupsCollection class @2-FDF02CAD
...
//Class_Initialize Event @2-9444F87B
...
//DataSource Variables @2-1B776B10
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-153BA345
...
//Open Method @2-D133EF52
    function Open()
    {
        ...
        "OrigApptMonth, OrigApptDay, OrigApptYear, employee.StatID AS employee_StatID, lut_status.* \n\n" .
        ...
        "employee.Sex = lut_sex.SexID) LEFT JOIN lut_status ON\n\n" .
        "employee.StatID = lut_status.StatID {SQL_Where} {SQL_OrderBy}";
...
//SetValues Method @2-9560D73F
    function SetValues()
    {
        ...
        $this->ReportLabel5->SetDBValue($this->f("OrigApptMonth"));
        $this->ReportLabel6->SetDBValue($this->f("OrigApptDay"));
        $this->ReportLabel7->SetDBValue($this->f("OrigApptYear"));
        $this->StatApp1->SetDBValue($this->f("Status"));
    }
...
//Class_Initialize Event @24-CF933921
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Query_EmpDepartmentNSPH.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpDepartmentNSPH.html";
$BlockToParse = "main";
...
//Include events file @1-677A879D
include_once("./Query_EmpDepartmentNSPH_events.php");
