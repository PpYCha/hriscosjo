<?php
//Include Common Files @1-32DD1058
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "EmployeeCopy.php");
...
//Variables @2-7079365E
    ...
    var $Sorter_EmpPicture;
    var $Sorter_MiddleInitial;
    var $Sorter_NameExtension;
    var $Sorter_BirthMonth;
    var $Sorter_BirthDay;
    var $Sorter_BirthYear;
    var $Sorter_PlaceOfBirth;
    var $Sorter_Sex;
    var $Sorter_CivilStatus;
    var $Sorter_Height;
    var $Sorter_Weight;
    var $Sorter_BloodType;
    var $Sorter_GsisIdNo;
    var $Sorter_GsisBPN;
//End Variables

//Class_Initialize Event @2-A1D07409
    function clsGridemployee($RelativePath, & $Parent)
    {
        ...
        $this->EmployeeID->Page = "EmployeeCopy.php";
        ...
        $this->EmpPicture = & new clsControl(ccsLabel, "EmpPicture", "EmpPicture", ccsText, "", CCGetRequestParam("EmpPicture", ccsGet, NULL), $this);
        $this->MiddleInitial = & new clsControl(ccsLabel, "MiddleInitial", "MiddleInitial", ccsText, "", CCGetRequestParam("MiddleInitial", ccsGet, NULL), $this);
        ...
        $this->PlaceOfBirth = & new clsControl(ccsLabel, "PlaceOfBirth", "PlaceOfBirth", ccsText, "", CCGetRequestParam("PlaceOfBirth", ccsGet, NULL), $this);
        $this->Sex = & new clsControl(ccsLabel, "Sex", "Sex", ccsText, "", CCGetRequestParam("Sex", ccsGet, NULL), $this);
        $this->CivilStatus = & new clsControl(ccsLabel, "CivilStatus", "CivilStatus", ccsText, "", CCGetRequestParam("CivilStatus", ccsGet, NULL), $this);
        $this->Height = & new clsControl(ccsLabel, "Height", "Height", ccsText, "", CCGetRequestParam("Height", ccsGet, NULL), $this);
        $this->Weight = & new clsControl(ccsLabel, "Weight", "Weight", ccsText, "", CCGetRequestParam("Weight", ccsGet, NULL), $this);
        $this->BloodType = & new clsControl(ccsLabel, "BloodType", "BloodType", ccsText, "", CCGetRequestParam("BloodType", ccsGet, NULL), $this);
        $this->GsisIdNo = & new clsControl(ccsLabel, "GsisIdNo", "GsisIdNo", ccsText, "", CCGetRequestParam("GsisIdNo", ccsGet, NULL), $this);
        $this->GsisBPN = & new clsControl(ccsLabel, "GsisBPN", "GsisBPN", ccsText, "", CCGetRequestParam("GsisBPN", ccsGet, NULL), $this);
        ...
        $this->employee_Insert->Page = "EmployeeCopy.php";
        $this->employee_TotalRecords = & new clsControl(ccsLabel, "employee_TotalRecords", "employee_TotalRecords", ccsText, "", CCGetRequestParam("employee_TotalRecords", ccsGet, NULL), $this);
        ...
        $this->Sorter_EmpPicture = & new clsSorter($this->ComponentName, "Sorter_EmpPicture", $FileName, $this);
        $this->Sorter_MiddleInitial = & new clsSorter($this->ComponentName, "Sorter_MiddleInitial", $FileName, $this);
        $this->Sorter_NameExtension = & new clsSorter($this->ComponentName, "Sorter_NameExtension", $FileName, $this);
        $this->Sorter_BirthMonth = & new clsSorter($this->ComponentName, "Sorter_BirthMonth", $FileName, $this);
        $this->Sorter_BirthDay = & new clsSorter($this->ComponentName, "Sorter_BirthDay", $FileName, $this);
        $this->Sorter_BirthYear = & new clsSorter($this->ComponentName, "Sorter_BirthYear", $FileName, $this);
        $this->Sorter_PlaceOfBirth = & new clsSorter($this->ComponentName, "Sorter_PlaceOfBirth", $FileName, $this);
        $this->Sorter_Sex = & new clsSorter($this->ComponentName, "Sorter_Sex", $FileName, $this);
        $this->Sorter_CivilStatus = & new clsSorter($this->ComponentName, "Sorter_CivilStatus", $FileName, $this);
        $this->Sorter_Height = & new clsSorter($this->ComponentName, "Sorter_Height", $FileName, $this);
        $this->Sorter_Weight = & new clsSorter($this->ComponentName, "Sorter_Weight", $FileName, $this);
        $this->Sorter_BloodType = & new clsSorter($this->ComponentName, "Sorter_BloodType", $FileName, $this);
        $this->Sorter_GsisIdNo = & new clsSorter($this->ComponentName, "Sorter_GsisIdNo", $FileName, $this);
        $this->Sorter_GsisBPN = & new clsSorter($this->ComponentName, "Sorter_GsisBPN", $FileName, $this);
...
//Show Method @2-C78FC318
    function Show()
    {
        ...
        $this->Sorter_EmpPicture->Show();
        $this->Sorter_MiddleInitial->Show();
        $this->Sorter_NameExtension->Show();
        $this->Sorter_BirthMonth->Show();
        $this->Sorter_BirthDay->Show();
        $this->Sorter_BirthYear->Show();
        $this->Sorter_PlaceOfBirth->Show();
        $this->Sorter_Sex->Show();
        $this->Sorter_CivilStatus->Show();
        $this->Sorter_Height->Show();
        $this->Sorter_Weight->Show();
        $this->Sorter_BloodType->Show();
        $this->Sorter_GsisIdNo->Show();
        $this->Sorter_GsisBPN->Show();
        $this->Navigator->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
...
//DataSource Variables @2-572D7D95
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-8AC5E1DA
...
//SetOrder Method @2-42C37F35
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "EmployeeID";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_EmployeeID" => array("EmployeeID", ""), 
            "Sorter_EmployeeIDNo" => array("EmployeeIDNo", ""), 
            "Sorter_Surname" => array("Surname", ""), 
            "Sorter_FirstName" => array("FirstName", ""), 
            "Sorter_MiddleName" => array("MiddleName", ""), 
            "Sorter_EmpPicture" => array("EmpPicture", ""), 
            "Sorter_MiddleInitial" => array("MiddleInitial", ""), 
            "Sorter_NameExtension" => array("NameExtension", ""), 
            "Sorter_BirthMonth" => array("BirthMonth", ""), 
            "Sorter_BirthDay" => array("BirthDay", ""), 
            "Sorter_BirthYear" => array("BirthYear", ""), 
            "Sorter_PlaceOfBirth" => array("PlaceOfBirth", ""), 
            "Sorter_Sex" => array("Sex", ""), 
            "Sorter_CivilStatus" => array("CivilStatus", ""), 
            "Sorter_Height" => array("Height", ""), 
            "Sorter_Weight" => array("Weight", ""), 
            "Sorter_BloodType" => array("BloodType", ""), 
            "Sorter_GsisIdNo" => array("GsisIdNo", ""), 
            "Sorter_GsisBPN" => array("GsisBPN", "")));
    }
//End SetOrder Method
...
//Class_Initialize Event @3-79D2C3B2
    function clsRecordemployeeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "EmployeeCopy.php";
...
//Operation Method @3-CBFDB124
    function Operation()
    {
        ...
        $Redirect = "EmployeeCopy.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "EmployeeCopy.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @76-6F77B9F4
    function clsRecordemployee1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->NameExtension = & new clsControl(ccsTextBox, "NameExtension", "Name Extension", ccsText, "", CCGetRequestParam("NameExtension", $Method, NULL), $this);
...
"FROM lut_sex {SQL_Where} {SQL_OrderBy}";
            list($this->Sex->BoundColumn, $this->Sex->TextColumn, $this->Sex->DBFormat) = array("Sex", "Sex", "");
...
"FROM lut_bloodtype {SQL_Where} {SQL_OrderBy}";
            ...
            $this->ResMunicipality = & new clsControl(ccsTextBox, "ResMunicipality", "Res Municipality", ccsText, "", CCGetRequestParam("ResMunicipality", $Method, NULL), $this);
            ...
            $this->PermMunicipality = & new clsControl(ccsTextBox, "PermMunicipality", "Perm Municipality", ccsText, "", CCGetRequestParam("PermMunicipality", $Method, NULL), $this);
            ...
            $this->SpouseNameExt = & new clsControl(ccsTextBox, "SpouseNameExt", "Spouse Name Ext", ccsText, "", CCGetRequestParam("SpouseNameExt", $Method, NULL), $this);
            ...
            $this->FatherNameExt = & new clsControl(ccsTextBox, "FatherNameExt", "Father Name Ext", ccsText, "", CCGetRequestParam("FatherNameExt", $Method, NULL), $this);
            ...
            $this->EmpPicture = & new clsControl(ccsTextBox, "EmpPicture", "Emp Picture", ccsText, "", CCGetRequestParam("EmpPicture", $Method, NULL), $this);
...
//Validate Method @76-21D28614
    function Validate()
    {
        ...
        $Validation = ($this->EmpPicture->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->EmpPicture->Errors->Count() == 0);
...
//CheckErrors Method @76-03ABDDDA
    function CheckErrors()
    {
        $errors = false;
...
//InsertRow Method @76-7ECFC336
    function InsertRow()
    {
        ...
        $this->DataSource->EmpPicture->SetValue($this->EmpPicture->GetValue(true));
...
//Show Method @76-FD5B9CCF
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->EmpPicture->Errors->ToString());
...
//DataSource Variables @76-47C55D62
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @76-28032BFA
...
//Insert Method @76-708EC557
    function Insert()
    {
        ...
        $this->InsertFields["EmpPicture"]["Value"] = $this->EmpPicture->GetDBValue(true);
...
//Update Method @76-347895C4
    function Update()
    {
        ...
        $this->UpdateFields["EmpPicture"]["Value"] = $this->EmpPicture->GetDBValue(true);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "EmployeeCopy.html";
$BlockToParse = "main";
...
//Include events file @1-829EEE42
include_once("./EmployeeCopy_events.php");
