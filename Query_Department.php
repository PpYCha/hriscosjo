<?php
//Include Common Files @1-685711D8
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_Department.php");
...
//employee_lut_statofappt2 ReportGroup class @2-D4EBB1E8
...
//employee_lut_statofappt2 GroupsCollection class @2-864BE624
...
//employee_lut_statofappt2 Variables @2-E87483F1
...
//Class_Initialize Event @2-A459714B
    function clsReportemployee_lut_statofappt2($RelativePath = "", & $Parent)
    {
        ...
        $this->SorterName = CCGetParam("employee_lut_statofappt2Order", "");
        $this->SorterDirection = CCGetParam("employee_lut_statofappt2Dir", "");
        ...
        $this->employee_Position->HTML = true;
        $this->employee_Position->EmptyText = "&nbsp;";
        $this->StatApp = & new clsControl(ccsReportLabel, "StatApp", "StatApp", ccsText, "", "", $this);
        $this->StatApp->HTML = true;
        $this->StatApp->EmptyText = "&nbsp;";
        ...
        $this->MiddleInitial->HTML = true;
        $this->MiddleInitial->EmptyText = "&nbsp;";
...
//DataSource Variables @2-8F117689
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-9074D16E
...
//Open Method @2-D6602981
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT Surname, FirstName, MiddleInitial, employee.Position AS employee_Position, employee.StatAppID AS employee_StatAppID, employee.OfficeID AS employee_OfficeID,\n\n" .
        "lut_statofappt2.*, NameOfficeDept \n\n" .
...
class clsRecorddepartmentoffice_employee { //departmentoffice_employee Class @17-B39F2074
...
//Class_Initialize Event @17-34C849B9
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_employee_OfficeID", "ccsForm"));
            $this->ClearParameters->Page = "Query_Department.php";
...
//CheckErrors Method @17-47365FBC
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @17-E0C80105
    function Operation()
    {
        ...
        $Redirect = "Query_Department.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Query_Department.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End departmentoffice_employee Class @17-FCB6E20C

//Initialize Page @1-619FCAEC
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_Department.html";
$BlockToParse = "main";
...
//Include events file @1-2A23CB38
include_once("./Query_Department_events.php");
...
$Report_Print->Page = "Query_Department.php";
...
//Go to destination page @1-F08D7F30
if($Redirect)
{
