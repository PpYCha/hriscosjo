<?php
//Include Common Files @1-98604BF6
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_nopending_inactiveelected2.php");
...
//Class_Initialize Event @2-EADB4E98
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->Hidden5 = & new clsControl(ccsHidden, "Hidden5", "Hidden5", ccsDate, array("mmmm", " ", "d", ", ", "yyyy"), CCGetRequestParam("Hidden5", ccsGet, NULL), $this);
...
//DataSourceClass_Initialize Event @2-C9E5DCA2
    function clsdepartmentoffice_employee1DataSource(& $Parent)
    {
        ...
        $this->Hidden5 = new clsField("Hidden5", ccsDate, $this->DateFormat);
...
//Open Method @2-350FCCE6
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, NameExtension, Identity, ORNo, IssuedOn, IssuedAt \n\n" .
...
//SetValues Method @2-A49A7851
    function SetValues()
    {
        ...
        $this->Hidden3->SetDBValue($this->f("Identity"));
        $this->Hidden4->SetDBValue($this->f("ORNo"));
        $this->Hidden5->SetDBValue(trim($this->f("IssuedOn")));
        $this->Hidden6->SetDBValue($this->f("IssuedAt"));
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_nopending_inactiveelected2.html";
$BlockToParse = "main";
...
//Include events file @1-986D20BA
include_once("./Cert_nopending_inactiveelected2_events.php");
