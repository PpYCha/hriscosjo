<?php
//Include Common Files @1-9D0F48D4
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryReassignDetailed.php");
...
//Class_Initialize Event @27-DC6BA684
    function clsRecorddepartmentoffice_departme($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "QueryReassignDetailed.php";
...
"FROM departmentoffice {SQL_Where} {SQL_OrderBy}";
            $this->s_ReassignmentOffice->DataSource->Order = "OfficeAcronym";
...
//Operation Method @27-A6440B4C
    function Operation()
    {
        ...
        $Redirect = "QueryReassignDetailed.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryReassignDetailed.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryReassignDetailed.html";
$BlockToParse = "main";
...
//Include events file @1-D1ABBD84
include_once("./QueryReassignDetailed_events.php");
