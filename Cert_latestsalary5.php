<?php
//Include Common Files @1-45627E5E
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary5.php");
...
//Class_Initialize Event @22-332D413B
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary5.php";
...
//Operation Method @22-9EE271CA
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary5.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary5.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary5.html";
$BlockToParse = "main";
...
//Include events file @1-361E59AE
include_once("./Cert_latestsalary5_events.php");
...
$Link9->Page = "Cert_employment_inactiveprintnoor.php";
...
$Link10->Page = "Cert_latestsalary_inactiveprintnoor.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_his_inactivenoor.php";
