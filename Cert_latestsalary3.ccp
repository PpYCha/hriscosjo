<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Print" sourceType="Table" returnValueType="Number" linesPerWebPage="40" connection="Connection1" dataSource="departmentoffice, employee, lut_servicerecpurpose, lut_statofappt2" activeCollection="TableParameters" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Servicerecpurpose " wizardLayoutType="Tabular">
			<Components>
				...
				<Section id="34" visible="True" lines="1" name="Detail">
					<Components>
						...
						<Hidden id="92" fieldSourceType="DBColumn" dataType="Text" name="Hidden2" PathID="departmentoffice_employee1DetailHidden2" fieldSource="StatApp">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<JoinTables>
				...
				<JoinTable id="4" tableName="employee" posLeft="160" posTop="10" posWidth="160" posHeight="315"/>
				<JoinTable id="6" tableName="lut_servicerecpurpose" posLeft="341" posTop="10" posWidth="128" posHeight="88"/>
				<JoinTable id="89" tableName="lut_statofappt2" posLeft="21" posTop="200" posWidth="95" posHeight="88"/>
			</JoinTables>
			<JoinLinks>
				...
				<JoinTable2 id="90" tableLeft="employee" tableRight="lut_statofappt2" fieldLeft="employee.StatAppID" fieldRight="lut_statofappt2.StatAppID" joinType="inner" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="88" tableName="employee" fieldName="employee.StatAppID" alias="employee_StatAppID"/>
				<Field id="91" tableName="lut_statofappt2" fieldName="lut_statofappt2.*"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
		...
		<Link id="79" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link10" PathID="Link10" wizardUseTemplateBlock="False" hrefSource="Cert_latestsalary_death.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
		...
		<Link id="87" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" PathID="Link1" wizardUseTemplateBlock="False" hrefSource="Cert_nopending_death.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_latestsalary3_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_latestsalary3.php" forShow="True" url="Cert_latestsalary3.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
