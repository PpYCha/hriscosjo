<?php
//Include Common Files @1-6E6213AC
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary7.php");
...
//Class_Initialize Event @22-AD823DAC
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary7.php";
...
//Operation Method @22-208FDA24
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary7.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary7.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary7.html";
$BlockToParse = "main";
...
//Include events file @1-9E98E83F
include_once("./Cert_latestsalary7_events.php");
...
$Link5->Page = "Cert_employment_electedprint.php";
...
$Link6->Page = "Cert_emp_compensatnElectd_print.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_electdprint.php";
...
$Link2->Page = "Cert_latestsalary_electedprint.php";
