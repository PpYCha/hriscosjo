<?php
//Include Common Files @1-EE419E9A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpID_print2.php");
...
//employee_departmentoffice ReportGroup class @2-20C2E003
...
//employee_departmentoffice GroupsCollection class @2-96A67344
...
//Class_Initialize Event @2-8C812A5C
...
//DataSource Variables @2-07FB4AFB
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2620A32E
...
//SetValues Method @2-0D8B42B4
    function SetValues()
    {
        ...
        $this->ReportLabel1->SetDBValue($this->f("BloodType"));
        $this->ReportLabel4->SetDBValue($this->f("AgencyEmpNo"));
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpID_print2.html";
$BlockToParse = "main";
...
//Include events file @1-42194CDE
include_once("./Query_EmpID_print2_events.php");
