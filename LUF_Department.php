<?php
//Include Common Files @1-CA774A4A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "LUF_Department.php");
...
//Class_Initialize Event @2-5993E6C5
    function clsGriddepartmentoffice($RelativePath, & $Parent)
    {
        ...
        $this->OfficeAcronym->Page = "LUF_Department.php";
        ...
        $this->departmentoffice_Insert->Page = "LUF_Department.php";
        $this->departmentoffice_TotalRecords = & new clsControl(ccsLabel, "departmentoffice_TotalRecords", "departmentoffice_TotalRecords", ccsInteger, array(False, 0, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("departmentoffice_TotalRecords", ccsGet, NULL), $this);
...
//Show Method @2-FB8ED137
    function Show()
    {
        ...
        $this->DataSource->Parameters["urls_NameOfficeHead"] = CCGetFromGet("s_NameOfficeHead", NULL);
...
//Prepare Method @2-77DEAA92
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_OfficeID", ccsInteger, "", "", $this->Parameters["urls_OfficeID"], "", false);
        $this->wp->AddParameter("2", "urls_NameOfficeDept", ccsText, "", "", $this->Parameters["urls_NameOfficeDept"], "", false);
        $this->wp->AddParameter("3", "urls_NameOfficeHead", ccsText, "", "", $this->Parameters["urls_NameOfficeHead"], "", false);
        ...
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "NameOfficeHead", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
...
//Class_Initialize Event @3-ECCB6350
    function clsRecorddepartmentofficeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_OfficeID", "s_NameOfficeDept", "s_NameOfficeHead", "ccsForm"));
            $this->ClearParameters->Page = "LUF_Department.php";
...
"FROM departmentoffice {SQL_Where} {SQL_OrderBy}";
            ...
            $this->s_NameOfficeHead = & new clsControl(ccsTextBox, "s_NameOfficeHead", "s_NameOfficeHead", ccsText, "", CCGetRequestParam("s_NameOfficeHead", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Validate Method @3-11D3A96F
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
        ...
        $Validation = ($this->s_NameOfficeHead->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->s_NameOfficeHead->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @3-BBEAB345
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->s_NameOfficeHead->Errors->Count());
...
//Operation Method @3-8C93A5DE
    function Operation()
    {
        ...
        $Redirect = "LUF_Department.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "LUF_Department.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @3-B3F11BE2
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->s_NameOfficeHead->Errors->ToString());
...
class clsRecorddepartmentoffice1 { //departmentoffice1 Class @39-E9C41A50
...
//Class_Initialize Event @39-E94CBAA5
...
//CheckErrors Method @39-14C349DC
    function CheckErrors()
    {
        $errors = false;
...
} //End departmentoffice1 Class @39-FCB6E20C

class clsdepartmentoffice1DataSource extends clsDBConnection1 {  //departmentoffice1DataSource Class @39-1525427A

//DataSource Variables @39-15861640
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @39-5D8BA0F8
...
} //End departmentoffice1DataSource Class @39-FCB6E20C

//Initialize Page @1-0EFE4C8E
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "LUF_Department.html";
$BlockToParse = "main";
...
//Include events file @1-A9E3EE9A
include_once("./LUF_Department_events.php");
