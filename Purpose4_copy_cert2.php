<?php
//Include Common Files @1-6A667014
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Purpose4_copy_cert2.php");
...
//Class_Initialize Event @2-B9DAAF16
    function clsGridemployee($RelativePath, & $Parent)
    {
        ...
        $this->Surname->Page = "Purpose4_copy_cert2.php";
        ...
        $this->employee_Insert->Page = "Purpose4_copy_cert2.php";
...
//Class_Initialize Event @38-8AC157A1
...
//Operation Method @38-0EE16BAF
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary1.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Purpose4_copy_cert2.html";
$BlockToParse = "main";
