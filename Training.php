<?php
//Include Common Files @1-DB12D77F
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Training.php");
...
//Class_Initialize Event @2-3C197DA5
    function clsGridemployee_training($RelativePath, & $Parent)
    {
        ...
        $this->EmployeeID->Page = "Training.php";
        ...
        $this->employee_training_Insert->Page = "Training.php";
...
//DataSourceClass_Initialize Event @2-9331947D
...
//SetOrder Method @2-901B10EB
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "TrainingID";
...
//Class_Initialize Event @30-71855310
...
//CheckErrors Method @30-88A586AC
...
//DataSourceClass_Initialize Event @30-3965AA98
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Training.html";
$BlockToParse = "main";
...
//Include events file @1-BDAF55C0
include_once("./Training_events.php");
