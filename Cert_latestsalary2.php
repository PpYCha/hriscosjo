<?php
//Include Common Files @1-2DE2FEB1
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary2.php");
...
//Class_Initialize Event @22-5BD03C99
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary2.php";
            ...
            $this->Link5->Page = "Cert_latestsalary5.php";
...
//CheckErrors Method @22-2DBCA567
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-D8135E4E
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary2.html";
$BlockToParse = "main";
...
//Include events file @1-AD1F56B4
include_once("./Cert_latestsalary2_events.php");
...
$Link9->Page = "Cert_employment_inactiveprint4.php";
...
$Link10->Page = "Cert_latestsalary_inactiveprint.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_his_inactive.php";
