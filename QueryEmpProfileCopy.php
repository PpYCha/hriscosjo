<?php
//Include Common Files @1-C1BA3F28
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryEmpProfileCopy.php");
...
//employee ReportGroup class @2-CFDB01FA
...
//employee GroupsCollection class @2-9739E00F
...
//Class_Initialize Event @2-7859FFA5
...
//DataSource Variables @2-C01ADDAD
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F3965099
...
//Class_Initialize Event @3-118D2BDC
    function clsRecordemployeeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "QueryEmpProfileCopy.php";
...
//Operation Method @3-4C2734CC
    function Operation()
    {
        ...
        $Redirect = "QueryEmpProfileCopy.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryEmpProfileCopy.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryEmpProfileCopy.html";
$BlockToParse = "main";
...
//Include events file @1-97EB18F5
include_once("./QueryEmpProfileCopy_events.php");
