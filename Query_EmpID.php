<?php
//Include Common Files @1-D7C40A11
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpID.php");
...
//employee_departmentoffice ReportGroup class @2-EE4DE8A1
...
//employee_departmentoffice GroupsCollection class @2-78740AB6
...
//Class_Initialize Event @2-4E8A009C
...
//DataSource Variables @2-D2794087
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E0D0756F
...
//Open Method @2-573D04F4
    function Open()
    {
        ...
        "PermZipcode, EmergencyName, EmergencyAddress, EmergencyContact \n\n" .
...
//SetValues Method @2-11D0A4F8
    function SetValues()
    {
        ...
        $this->ReportLabel2->SetDBValue($this->f("Tin"));
        $this->ReportLabel3->SetDBValue($this->f("AgencyEmpNo"));
    }
...
//Class_Initialize Event @24-459A1397
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_employee_OfficeID", "s_EmployeeIDNo", "s_Surname", "s_FirstName", "s_MiddleName", "CheckBoxList1", "ccsForm"));
            $this->ClearParameters->Page = "Query_EmpID.php";
...
//CheckErrors Method @24-21B4ED34
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @24-6F74674D
    function Operation()
    {
        ...
        $Redirect = "Query_EmpID.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Query_EmpID.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpID.html";
$BlockToParse = "main";
...
//Include events file @1-547D0D6D
include_once("./Query_EmpID_events.php");
...
$Report_Print->Page = "Query_EmpID_print2.php";
...
$Link2->Page = "Query_EmpID_print3.php";
