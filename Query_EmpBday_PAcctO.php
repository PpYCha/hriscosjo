<?php
//Include Common Files @1-6B0F0C85
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpBday_PAcctO.php");
...
//departmentoffice_employee1 ReportGroup class @2-11A7CC8D
...
//departmentoffice_employee1 GroupsCollection class @2-384418E8
...
//Class_Initialize Event @2-DF070CC3
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->ReportLabel1 = & new clsControl(ccsReportLabel, "ReportLabel1", "ReportLabel1", ccsDate, array("mmmm", " ", "d", ", ", "yyyy"), "", $this);
...
//DataSource Variables @2-CABBB51A
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-24A37EB8
...
//Class_Initialize Event @24-280D1528
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Query_EmpBday_PAcctO.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpBday_PAcctO.html";
$BlockToParse = "main";
...
//Include events file @1-A6FBD71E
include_once("./Query_EmpBday_PAcctO_events.php");
...
$Report_Print->Page = "Query_EmpDepartment2_print.php";
