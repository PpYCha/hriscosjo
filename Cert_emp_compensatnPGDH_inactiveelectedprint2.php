<?php
//Include Common Files @1-CAEDF37C
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_emp_compensatnPGDH_inactiveelectedprint2.php");
...
//departmentoffice_employee1 ReportGroup class @2-1A64A980
...
//departmentoffice_employee1 GroupsCollection class @2-B4CB3C40
...
//Class_Initialize Event @2-33C7E6CB
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->MonthlySalary = & new clsControl(ccsHidden, "MonthlySalary", "MonthlySalary", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("MonthlySalary", ccsGet, NULL), $this);
        ...
        $this->Hidden6 = & new clsControl(ccsHidden, "Hidden6", "Hidden6", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("Hidden6", ccsGet, NULL), $this);
        ...
        $this->Hidden11 = & new clsControl(ccsHidden, "Hidden11", "Hidden11", ccsDate, array("mmmm", " ", "d", ", ", "yyyy"), CCGetRequestParam("Hidden11", ccsGet, NULL), $this);
...
//DataSource Variables @2-C9C4CEEF
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-8AF8F6F2
    function clsdepartmentoffice_employee1DataSource(& $Parent)
    {
        ...
        $this->MonthlySalary = new clsField("MonthlySalary", ccsFloat, "");
        ...
        $this->Hidden6 = new clsField("Hidden6", ccsFloat, "");
        ...
        $this->Hidden11 = new clsField("Hidden11", ccsDate, $this->DateFormat);
...
//Open Method @2-99438878
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, OrigApptMonth, OrigApptDay, OrigApptYear, MonthlySalary+2000.00+16150.00 AS Expr1,\n\n" .
        "LastServiceMonth, LastServiceDay, LastService, NameExtension, ORNo, IssuedOn, IssuedAt \n\n" .
...
//SetValues Method @2-1A9C926C
    function SetValues()
    {
        ...
        $this->Hidden6->SetDBValue(trim($this->f("Expr1")));
        $this->Hidden5->SetDBValue($this->f("LastServiceMonth"));
        $this->Hidden7->SetDBValue($this->f("LastServiceDay"));
        $this->Hidden8->SetDBValue($this->f("LastService"));
        $this->Hidden9->SetDBValue($this->f("NameExtension"));
        $this->Hidden10->SetDBValue($this->f("ORNo"));
        $this->Hidden11->SetDBValue(trim($this->f("IssuedOn")));
        $this->Hidden12->SetDBValue($this->f("IssuedAt"));
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_emp_compensatnPGDH_inactiveelectedprint2.html";
$BlockToParse = "main";
...
//Include events file @1-9A572B38
include_once("./Cert_emp_compensatnPGDH_inactiveelectedprint2_events.php");
