<?php
//Include Common Files @1-58B03EF2
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "WorkExperience.php");
...
//Class_Initialize Event @2-7B44D42A
    function clsGridemployee_workexperience($RelativePath, & $Parent)
    {
        ...
        $this->EmployeeID->Page = "WorkExperience.php";
        ...
        $this->MonthlySalary = & new clsControl(ccsLabel, "MonthlySalary", "MonthlySalary", ccsSingle, "", CCGetRequestParam("MonthlySalary", ccsGet, NULL), $this);
        ...
        $this->employee_workexperience_Insert->Page = "WorkExperience.php";
...
//DataSource Variables @2-6A1A8D2D
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-3D242811
...
//SetOrder Method @2-8CA0ED76
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "MonthlySalary";
...
//Class_Initialize Event @39-6A72D40B
...
//CheckErrors Method @39-07E43B9E
...
//DataSourceClass_Initialize Event @39-F898DA55
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "WorkExperience.html";
$BlockToParse = "main";
...
//Include events file @1-27046B40
include_once("./WorkExperience_events.php");
