...
//departmentoffice_employee_BeforeShow @23-D32924BE
...
//Hide-Show Component @33-286F3E6C
...
//Close departmentoffice_employee_BeforeShow @23-554DD2D7
    return $departmentoffice_employee_BeforeShow;
}
//End Close departmentoffice_employee_BeforeShow

//Report_Print_BeforeShow @30-6CD7E3F9
...
//Hide-Show Component @32-286F3E6C
    $Parameter1 = CCGetFromGet("ViewMode", "");
    $Parameter2 = "Print";
    if (0 == CCCompareValues($Parameter1, $Parameter2, ccsText))
        $Component->Visible = false;
...
//Close Report_Print_BeforeShow @30-0DD1CC60
