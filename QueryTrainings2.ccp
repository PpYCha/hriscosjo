<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="65" linesPerPhysicalPage="50" connection="Connection1" dataSource="departmentoffice, employee, employee_training" name="departmentoffice_employee1" orderBy="DateTo" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Employee Training " wizardLayoutType="GroupLeftAbove">
			<Components>
				...
				<Section id="33" visible="True" lines="1" name="Page_Header" wizardSectionType="PageHeader">
					<Components>
						<Sorter id="72" visible="True" name="Sorter_EmployeeIDNo" column="EmployeeIDNo" wizardCaption="Employee IDNo" wizardSortingType="SimpleDir" wizardControl="EmployeeIDNo">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="74" visible="True" name="Sorter_TrainingTitle" column="TrainingTitle" wizardCaption="Training Title" wizardSortingType="SimpleDir" wizardControl="TrainingTitle">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="76" visible="True" name="Sorter_DateFrom" column="DateFrom" wizardCaption="Date From" wizardSortingType="SimpleDir" wizardControl="DateFrom">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="78" visible="True" name="Sorter_DateTo" column="DateTo" wizardCaption="Date To" wizardSortingType="SimpleDir" wizardControl="DateTo">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="80" visible="True" name="Sorter_NoOfHours" column="NoOfHours" wizardCaption="No Of Hours" wizardSortingType="SimpleDir" wizardControl="NoOfHours">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="82" visible="True" name="Sorter_TrainingCategory" column="TrainingCategory" wizardCaption="Training Category" wizardSortingType="SimpleDir" wizardControl="TrainingCategory">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="84" visible="True" name="Sorter_ConductedBy" column="ConductedBy" wizardCaption="Conducted By" wizardSortingType="SimpleDir" wizardControl="ConductedBy">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="35" visible="True" lines="1" name="OfficeAcronym_Header">
					<Components>
				...
				<Section id="43" visible="True" lines="0" name="MiddleName_Footer">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Section id="46" visible="True" lines="0" name="OfficeAcronym_Footer">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Section>
				<Section id="47" visible="True" lines="0" name="Report_Footer" wizardSectionType="ReportFooter">
					<Components>
						<Panel id="48" visible="True" name="NoRecords" wizardNoRecords="No records">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="49" visible="True" lines="2" name="Page_Footer" wizardSectionType="PageFooter" pageBreakAfter="True">
					<Components>
						<Panel id="55" visible="True" name="PageBreak">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						...
						<ReportLabel id="57" fieldSourceType="SpecialValue" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalPages" fieldSource="TotalPages" wizardUseTemplateBlock="False" wizardAddNbsp="False" wizardAlign="right" wizardPrefix=" of " PathID="departmentoffice_employee1Page_FooterReport_TotalPages">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<Navigator id="58" size="10" type="Centered" pageSizes="1;5;10;25;50" name="Navigator" wizardPagingType="Centered" wizardFirst="True" wizardFirstText="First" wizardPrev="True" wizardPrevText="Prev" wizardNext="True" wizardNextText="Next" wizardLast="True" wizardLastText="Last" wizardPageNumbers="Centered" wizardSize="10" wizardTotalPages="True" wizardHideDisabled="False" wizardOfText="of" wizardImagesScheme="Joyful">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
										<Action actionName="Hide-Show Component" actionCategory="General" id="59" action="Hide" conditionType="Parameter" dataType="Integer" condition="LessThan" name1="TotalPages" sourceType1="SpecialValue" name2="2" sourceType2="Expression"/>
									</Actions>
								</Event>
							</Events>
							<Attributes/>
			...
			<Events/>
			<TableParameters>
				<TableParameter id="60" conditionType="Parameter" useIsNull="False" field="EmployeeIDNo" parameterSource="s_EmployeeIDNo" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="1"/>
				<TableParameter id="61" conditionType="Parameter" useIsNull="False" field="Surname" parameterSource="s_Surname" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="2"/>
				<TableParameter id="62" conditionType="Parameter" useIsNull="False" field="FirstName" parameterSource="s_FirstName" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="3"/>
				<TableParameter id="63" conditionType="Parameter" useIsNull="False" field="MiddleName" parameterSource="s_MiddleName" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="4"/>
				<TableParameter id="64" conditionType="Parameter" useIsNull="False" field="employee.OfficeID" parameterSource="s_OfficeID" dataType="Integer" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="5"/>
				<TableParameter id="65" conditionType="Parameter" useIsNull="False" field="StatAppt" parameterSource="s_StatAppt" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="6"/>
				<TableParameter id="66" conditionType="Parameter" useIsNull="False" field="TrainingTitle" parameterSource="s_TrainingTitle" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="7"/>
				<TableParameter id="67" conditionType="Parameter" useIsNull="False" field="DateFrom" parameterSource="s_DateFrom" dataType="Date" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="8"/>
				<TableParameter id="68" conditionType="Parameter" useIsNull="False" field="DateTo" parameterSource="s_DateTo" dataType="Date" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="9"/>
				<TableParameter id="69" conditionType="Parameter" useIsNull="False" field="NoOfHours" parameterSource="s_NoOfHours" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="10"/>
				<TableParameter id="70" conditionType="Parameter" useIsNull="False" field="TrainingCategory" parameterSource="s_TrainingCategory" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="11"/>
				<TableParameter id="71" conditionType="Parameter" useIsNull="False" field="ConductedBy" parameterSource="s_ConductedBy" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="12"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="3" tableName="departmentoffice" posLeft="291" posTop="214" posWidth="129" posHeight="180"/>
				<JoinTable id="4" tableName="employee" posLeft="246" posTop="6" posWidth="160" posHeight="180"/>
			...
			<ReportGroups>
				...
				<ReportGroup id="36" name="Surname" field="Surname" sqlField="employee.Surname" sortOrder="asc"/>
				<ReportGroup id="38" name="FirstName" field="FirstName" sqlField="employee.FirstName" sortOrder="asc"/>
				<ReportGroup id="40" name="MiddleName" field="MiddleName" sqlField="employee.MiddleName" sortOrder="asc"/>
			</ReportGroups>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		</Report>
		<Record id="11" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="QueryTrainings2.ccp" PathID="departmentoffice_employee">
			<Components>
				<Link id="12" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="QueryTrainings2.ccp" removeParameters="s_EmployeeIDNo;s_Surname;s_FirstName;s_MiddleName;s_OfficeID;s_StatAppt;s_TrainingTitle;s_DateFrom;s_DateTo;s_NoOfHours;s_TrainingCategory;s_ConductedBy" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
		...
		<Link id="28" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Report_Print" hrefSource="QueryTrainings2.ccp" wizardTheme="Joyful" wizardThemeType="File" wizardDefaultValue="Printable version" wizardUseTemplateBlock="True" wizardBeforeHTML="&lt;p align=&quot;right&quot;&gt;" wizardAfterHTML="&lt;/p&gt;" wizardLinkTarget="_blank" PathID="Report_Print">
			<Components/>
			<Events>
				<Event name="BeforeShow" type="Server">
					<Actions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="QueryTrainings2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="QueryTrainings2.php" forShow="True" url="QueryTrainings2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
