<?php
//Include Common Files @1-6AA2A282
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ReportServiceRecord.php");
...
//employee_employee_service1 ReportGroup class @2-8EB758F6
...
//employee_employee_service1 GroupsCollection class @2-B6CCCAEC
...
//Class_Initialize Event @2-3C9C6EAF
...
//Class_Initialize Event @11-4C9FE741
    function clsRecordemployee_employee_service($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "ReportServiceRecord.php";
...
//Operation Method @11-A7847B83
    function Operation()
    {
        ...
        $Redirect = "ReportServiceRecord.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ReportServiceRecord.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ReportServiceRecord.html";
$BlockToParse = "main";
...
//Include events file @1-0A88CE77
include_once("./ReportServiceRecord_events.php");
...
$Report_Print->Page = "ReportServiceRecord.php";
