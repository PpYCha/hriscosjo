<?php
//Include Common Files @1-03AC09A9
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QEmp_Skills2.php");
...
//employee_employee_special ReportGroup class @2-D7F1DFF8
class clsReportGroupemployee_employee_special {
    var $GroupType;
    ...
    function clsReportGroupemployee_employee_special(& $parent) {
        $this->Parent = & $parent;
...
//End employee_employee_special ReportGroup class

//employee_employee_special GroupsCollection class @2-6EB15823
class clsGroupsCollectionemployee_employee_special {
    var $Groups;
    ...
    function clsGroupsCollectionemployee_employee_special(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupemployee_employee_special($this->Parent);
...
//End employee_employee_special GroupsCollection class

class clsReportemployee_employee_special { //employee_employee_special Class @2-5746818F

//employee_employee_special Variables @2-87F7EA53
...
//End employee_employee_special Variables

//Class_Initialize Event @2-C49EB1C4
    function clsReportemployee_employee_special($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "employee_employee_special";
        $this->Visible = True;
        $this->Parent = & $Parent;
        ...
        $this->DataSource = new clsemployee_employee_specialDataSource($this);
...
//Show Method @2-4270AC43
    function Show()
    {
        ...
        $Groups = new clsGroupsCollectionemployee_employee_special($this);
...
} //End employee_employee_special Class @2-FCB6E20C

class clsemployee_employee_specialDataSource extends clsDBConnection1 {  //employee_employee_specialDataSource Class @2-0462EC8E

//DataSource Variables @2-3A0559B2
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-317847A6
    function clsemployee_employee_specialDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report employee_employee_special";
        $this->Initialize();
...
//Open Method @2-8A27E07E
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT EmployeeIDNo, employee_specialskills.*, Surname, FirstName, MiddleName, NameExtension, EmpPicture \n\n" .
        "FROM employee_specialskills INNER JOIN employee ON\n\n" .
        "employee_specialskills.EmployeeID = employee.EmployeeID {SQL_Where} {SQL_OrderBy}";
...
} //End employee_employee_specialDataSource Class @2-FCB6E20C

//Initialize Page @1-A8D7820A
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QEmp_Skills2.html";
$BlockToParse = "main";
...
//Include events file @1-916CA271
include_once("./QEmp_Skills2_events.php");
...
$Report_Print->Page = "QEmp_Skills2_print.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Q_Employee.php";
$employee_employee_special = & new clsReportemployee_employee_special("", $MainPage);
$MainPage->Report_Print = & $Report_Print;
$MainPage->Link1 = & $Link1;
$MainPage->employee_employee_special = & $employee_employee_special;
$Report_Print->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Report_Print->Parameters = CCAddParam($Report_Print->Parameters, "ViewMode", "Print");
$employee_employee_special->Initialize();
...
//Go to destination page @1-6FA367E8
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConnection1->close();
    header("Location: " . $Redirect);
    unset($employee_employee_special);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-6A9C57C5
$employee_employee_special->Show();
$Report_Print->Show();
$Link1->Show();
$Tpl->block_path = "";
