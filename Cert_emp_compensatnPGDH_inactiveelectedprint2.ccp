<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Print" sourceType="Table" returnValueType="Number" linesPerWebPage="40" connection="Connection1" dataSource="departmentoffice, employee, lut_servicerecpurpose" activeCollection="TableParameters" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Servicerecpurpose " wizardLayoutType="Tabular" pasteActions="pasteActions">
			<Components>
				...
				<Section id="34" visible="True" lines="1" name="Detail">
					<Components>
						...
						<Hidden id="82" fieldSourceType="DBColumn" dataType="Text" name="Hidden5" PathID="departmentoffice_employee1DetailHidden5" fieldSource="LastServiceMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="83" fieldSourceType="DBColumn" dataType="Text" name="Hidden7" PathID="departmentoffice_employee1DetailHidden7" fieldSource="LastServiceDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="84" fieldSourceType="DBColumn" dataType="Text" name="Hidden8" PathID="departmentoffice_employee1DetailHidden8" fieldSource="LastService">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="89" fieldSourceType="DBColumn" dataType="Text" name="Hidden9" PathID="departmentoffice_employee1DetailHidden9" fieldSource="NameExtension">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="90" fieldSourceType="DBColumn" dataType="Text" name="Hidden10" PathID="departmentoffice_employee1DetailHidden10" fieldSource="ORNo">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="91" fieldSourceType="DBColumn" dataType="Date" name="Hidden11" PathID="departmentoffice_employee1DetailHidden11" fieldSource="IssuedOn" format="mmmm d, yyyy">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Hidden>
						<Hidden id="92" fieldSourceType="DBColumn" dataType="Text" name="Hidden12" PathID="departmentoffice_employee1DetailHidden12" fieldSource="IssuedAt">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<JoinTables>
				...
				<JoinTable id="4" tableName="employee" posLeft="160" posTop="10" posWidth="160" posHeight="303"/>
			...
			<Fields>
				...
				<Field id="78" fieldName="MonthlySalary+2000.00+16150.00" isExpression="True" alias="Expr1"/>
				<Field id="85" tableName="employee" fieldName="LastServiceMonth"/>
				<Field id="86" tableName="employee" fieldName="LastServiceDay"/>
				<Field id="87" tableName="employee" fieldName="LastService"/>
				<Field id="88" tableName="employee" fieldName="NameExtension"/>
				<Field id="93" tableName="employee" fieldName="ORNo"/>
				<Field id="94" tableName="employee" fieldName="IssuedOn"/>
				<Field id="95" tableName="employee" fieldName="IssuedAt"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_emp_compensatnPGDH_inactiveelectedprint2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="Cert_emp_compensatnPGDH_inactiveelectedprint2.php" forShow="True" url="Cert_emp_compensatnPGDH_inactiveelectedprint2.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
