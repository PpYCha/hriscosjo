...
<Field id="82" tableName="employee" fieldName="IssuedAt"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_nopending_his_inactive_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_nopending_his_inactive.php" forShow="True" url="Cert_nopending_his_inactive.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
