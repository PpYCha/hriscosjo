<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="70" linesPerPhysicalPage="500" connection="Connection1" dataSource="departmentoffice, lut_modeseparatn, lut_statofappt2, employee" name="employee_lut_statofappt2" pageSizeLimit="500" wizardCaption=" Employee, Lut Statofappt2, Departmentoffice, Lut Modeseparatn " wizardLayoutType="Form" activeCollection="TableParameters" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Section id="85" visible="True" lines="68" name="Detail" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						...
						<ReportLabel id="115" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="EntranceGovMonth" fieldSource="EntranceGovMonth" wizardCaption="EntranceGovMonth" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="employee_lut_statofappt2DetailEntranceGovMonth">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						...
						<ReportLabel id="116" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="EntranceGovDay" fieldSource="EntranceGovDay" wizardCaption="EntranceGovDay" wizardSize="2" wizardMaxLength="2" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="employee_lut_statofappt2DetailEntranceGovDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="117" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="EntranceGovYear" fieldSource="EntranceGovYear" wizardCaption="EntranceGovYear" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="employee_lut_statofappt2DetailEntranceGovYear">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						...
						<ReportLabel id="178" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="SeparationMonth1" fieldSource="SeparationMonth" wizardCaption="SeparationMonth" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="employee_lut_statofappt2DetailSeparationMonth1">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="152" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="SeparationDay" fieldSource="SeparationDay" wizardCaption="SeparationDay" wizardSize="2" wizardMaxLength="2" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="employee_lut_statofappt2DetailSeparationDay">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="153" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="SeparationYear" fieldSource="SeparationYear" wizardCaption="SeparationYear" wizardSize="4" wizardMaxLength="4" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="employee_lut_statofappt2DetailSeparationYear">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						...
						<CheckBox id="192" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="CheckBox1" PathID="employee_lut_statofappt2DetailCheckBox1" fieldSource="DesignationID" checkedValue="1" uncheckedValue="0">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</CheckBox>
						<ReportLabel id="193" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel4" PathID="employee_lut_statofappt2DetailReportLabel4" fieldSource="Designation">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="194" fieldSourceType="DBColumn" dataType="Date" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel5" PathID="employee_lut_statofappt2DetailReportLabel5" fieldSource="DesignationDate" format="mmmm d, yyyy">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</ReportLabel>
						<ReportLabel id="195" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel6" PathID="employee_lut_statofappt2DetailReportLabel6" fieldSource="DesignationRemarks">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<JoinTables>
				<JoinTable id="22" tableName="departmentoffice" posLeft="280" posTop="8" posWidth="129" posHeight="112"/>
				<JoinTable id="66" tableName="lut_modeseparatn" posLeft="287" posTop="224" posWidth="108" posHeight="88"/>
				<JoinTable id="170" tableName="lut_statofappt2" posLeft="282" posTop="137" posWidth="95" posHeight="88"/>
				<JoinTable id="196" tableName="employee" posLeft="21" posTop="10" posWidth="160" posHeight="288"/>
			</JoinTables>
			<JoinLinks>
			...
			<Fields>
				...
				<Field id="191" fieldName="(BirthDate+65)" isExpression="True" alias="Expr2"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="QEmp_CurrentPosition_print2.php" forShow="True" url="QEmp_CurrentPosition_print2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
