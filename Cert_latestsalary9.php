<?php
//Include Common Files @1-BF631272
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary9.php");
...
//Class_Initialize Event @22-C22C46CB
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary9.php";
...
//Operation Method @22-AD6D852C
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary9.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary9.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary9.html";
$BlockToParse = "main";
...
//Include events file @1-73EBF04A
include_once("./Cert_latestsalary9_events.php");
...
$Link9->Page = "Cert_employment_inactiveelectedprint2.php";
...
$Link10->Page = "Cert_latestsalary_inactiveelectedprint2.php";
...
$Link12->Page = "Cert_emp_compensatnPGDH_inactiveelectedprint2.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_inactiveelected2.php";
