...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="QueryBirthday_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="QueryBirthday.php" forShow="True" url="QueryBirthday.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
