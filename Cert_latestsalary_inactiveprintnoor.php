<?php
//Include Common Files @1-9377FC3E
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary_inactiveprintnoor.php");
...
//departmentoffice_employee1 ReportGroup class @2-335A99BB
class clsReportGroupdepartmentoffice_employee1 {
    ...
    var $Hidden12, $_Hidden12Attributes;
    var $Hidden13, $_Hidden13Attributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->Hidden12 = $this->Parent->Hidden12->Value;
        $this->Hidden13 = $this->Parent->Hidden13->Value;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_Hidden12Attributes = $this->Parent->Hidden12->Attributes->GetAsArray();
        $this->_Hidden13Attributes = $this->Parent->Hidden13->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->Hidden12 = $Header->Hidden12;
        $Header->_Hidden12Attributes = $this->_Hidden12Attributes;
        $this->Parent->Hidden12->Value = $Header->Hidden12;
        $this->Parent->Hidden12->Attributes->RestoreFromArray($Header->_Hidden12Attributes);
        $this->Hidden13 = $Header->Hidden13;
        $Header->_Hidden13Attributes = $this->_Hidden13Attributes;
        $this->Parent->Hidden13->Value = $Header->Hidden13;
        $this->Parent->Hidden13->Attributes->RestoreFromArray($Header->_Hidden13Attributes);
...
//departmentoffice_employee1 GroupsCollection class @2-A3C01CF9
class clsGroupsCollectiondepartmentoffice_employee1 {
    ...
    function RestoreValues() {
        ...
        $this->Parent->Hidden12->Value = $this->Parent->Hidden12->initialValue;
        $this->Parent->Hidden13->Value = $this->Parent->Hidden13->initialValue;
...
//Class_Initialize Event @2-077C4AE9
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->Hidden4 = & new clsControl(ccsHidden, "Hidden4", "Hidden4", ccsDate, array("mmmm", " ", "d", ", ", "yyyy"), CCGetRequestParam("Hidden4", ccsGet, NULL), $this);
        ...
        $this->Hidden10 = & new clsControl(ccsHidden, "Hidden10", "Hidden10", ccsText, "", CCGetRequestParam("Hidden10", ccsGet, NULL), $this);
        $this->Hidden11 = & new clsControl(ccsHidden, "Hidden11", "Hidden11", ccsText, "", CCGetRequestParam("Hidden11", ccsGet, NULL), $this);
        $this->Hidden12 = & new clsControl(ccsHidden, "Hidden12", "Hidden12", ccsText, "", CCGetRequestParam("Hidden12", ccsGet, NULL), $this);
        $this->Hidden13 = & new clsControl(ccsHidden, "Hidden13", "Hidden13", ccsText, "", CCGetRequestParam("Hidden13", ccsGet, NULL), $this);
...
//CheckErrors Method @2-3E9527EB
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->Hidden12->Errors->Count());
        $errors = ($errors || $this->Hidden13->Errors->Count());
...
//GetErrors Method @2-9AF25ED3
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->Hidden12->Errors->ToString());
        $errors = ComposeStrings($errors, $this->Hidden13->Errors->ToString());
...
//Show Method @2-5BE85F2E
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            $this->Hidden12->SetValue($this->DataSource->Hidden12->GetValue());
            $this->Hidden13->SetValue($this->DataSource->Hidden13->GetValue());
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["Hidden12"] = $this->Hidden12->Visible;
            $this->ControlsVisible["Hidden13"] = $this->Hidden13->Visible;
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->Hidden12->SetValue($items[$i]->Hidden12);
                        $this->Hidden12->Attributes->RestoreFromArray($items[$i]->_Hidden12Attributes);
                        $this->Hidden13->SetValue($items[$i]->Hidden13);
                        $this->Hidden13->Attributes->RestoreFromArray($items[$i]->_Hidden13Attributes);
...
//DataSource Variables @2-B16CE112
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-5BBAC037
    function clsdepartmentoffice_employee1DataSource(& $Parent)
    {
        ...
        $this->Hidden4 = new clsField("Hidden4", ccsDate, $this->DateFormat);
        ...
        $this->Hidden10 = new clsField("Hidden10", ccsText, "");
        
        $this->Hidden11 = new clsField("Hidden11", ccsText, "");
        
        $this->Hidden12 = new clsField("Hidden12", ccsText, "");
        
        $this->Hidden13 = new clsField("Hidden13", ccsText, "");
...
//Prepare Method @2-DA4D6F96
    function Prepare()
    {
        ...
        $this->wp->Criterion[4] = $this->wp->Operation(opContains, "employee.MiddleInitial", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
...
//Open Method @2-63706FE5
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, NameExtension, ORNo, IssuedOn, IssuedAt, lut_statofappt2.*, employee.StatAppID AS employee_StatAppID,\n\n" .
        "OrigApptMonth, OrigApptDay, OrigApptYear, LastServiceMonth, LastServiceDay, LastService, Rate \n\n" .
...
//SetValues Method @2-3A5DB811
    function SetValues()
    {
        ...
        $this->Hidden2->SetDBValue($this->f("NameExtension"));
        $this->Hidden3->SetDBValue($this->f("ORNo"));
        $this->Hidden4->SetDBValue(trim($this->f("IssuedOn")));
        $this->Hidden5->SetDBValue($this->f("IssuedAt"));
        $this->Hidden6->SetDBValue($this->f("StatApp"));
        $this->Hidden7->SetDBValue($this->f("OrigApptMonth"));
        $this->Hidden8->SetDBValue($this->f("OrigApptDay"));
        $this->Hidden9->SetDBValue($this->f("OrigApptYear"));
        $this->Hidden10->SetDBValue($this->f("LastServiceMonth"));
        $this->Hidden11->SetDBValue($this->f("LastServiceDay"));
        $this->Hidden12->SetDBValue($this->f("LastService"));
        $this->Hidden13->SetDBValue($this->f("Rate"));
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary_inactiveprintnoor.html";
$BlockToParse = "main";
...
//Include events file @1-E8524B63
include_once("./Cert_latestsalary_inactiveprintnoor_events.php");
