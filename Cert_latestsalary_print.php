<?php
//Include Common Files @1-B05BDAFB
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary_print.php");
...
//departmentoffice_employee1 ReportGroup class @2-4F812B61
...
//departmentoffice_employee1 GroupsCollection class @2-3143A2C1
...
//Class_Initialize Event @2-23E3724C
...
//DataSource Variables @2-A5CCD85F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-25DE5274
...
//Open Method @2-3704F70D
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, NameExtension, lut_statofappt2.*, OrigApptMonth, OrigApptDay, OrigApptYear,\n\n" .
        "Rate \n\n" .
...
//SetValues Method @2-BFBD64C1
    function SetValues()
    {
        ...
        $this->Hidden3->SetDBValue($this->f("StatApp"));
        $this->Hidden4->SetDBValue($this->f("OrigApptMonth"));
        $this->Hidden5->SetDBValue($this->f("OrigApptDay"));
        $this->Hidden6->SetDBValue($this->f("OrigApptYear"));
        $this->Hidden7->SetDBValue($this->f("Rate"));
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary_print.html";
$BlockToParse = "main";
...
//Include events file @1-4CA11C2E
include_once("./Cert_latestsalary_print_events.php");
