<?php
//Include Common Files @1-A40DD007
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_nopending_electdprint.php");
...
//departmentoffice_employee1 ReportGroup class @2-30302907
...
//departmentoffice_employee1 GroupsCollection class @2-4AFF9786
...
//Class_Initialize Event @2-9A69696F
...
//DataSource Variables @2-5E8323DB
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E9DDC00B
...
//Open Method @2-C3B801C1
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, NameExtension, Identity \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_nopending_electdprint.html";
$BlockToParse = "main";
...
//Include events file @1-ED26CF89
include_once("./Cert_nopending_electdprint_events.php");
