<?php
//Include Common Files @1-6837F470
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_employment_print.php");
...
//Open Method @2-0EABD91F
    function Open()
    {
        ...
        "SalaryWords, CertDay, CertMonth, CertYear, Title, OrigApptMonth, OrigApptDay, OrigApptYear, NameExtension, employee.StatAppID AS employee_StatAppID,\n\n" .
        "lut_statofappt2.* \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_employment_print.html";
$BlockToParse = "main";
...
//Include events file @1-FE41D8A0
include_once("./Cert_employment_print_events.php");
