<?php
//Include Common Files @1-00E9300A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpDepartment2.php");
...
//Class_Initialize Event @2-AEFEDDED
...
//Open Method @2-3913DD25
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT StatApp, OfficeAcronym, lut_sex.*, employee.Position AS employee_Position, Surname, FirstName, MiddleName, MiddleInitial, NameExtension \n\n" .
...
//Class_Initialize Event @24-6148F0DC
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Query_EmpDepartment2.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpDepartment2.html";
$BlockToParse = "main";
...
//Include events file @1-8D651FDB
include_once("./Query_EmpDepartment2_events.php");
