<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" connection="Connection1" dataSource="departmentoffice, employee, lut_sex" orderBy="Surname" name="departmentoffice_employee1" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Sex " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			<Components>
			...
			<TableParameters>
				...
				<TableParameter id="50" conditionType="Parameter" useIsNull="False" field="BirthMonth" dataType="Text" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="2" parameterSource="s_BirthMonth"/>
				<TableParameter id="51" conditionType="Parameter" useIsNull="False" field="BirthDay" dataType="Text" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="3" parameterSource="s_BirthDay"/>
				<TableParameter id="52" conditionType="Parameter" useIsNull="False" field="BirthYear" dataType="Text" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="4" parameterSource="s_BirthYear"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="3" tableName="departmentoffice" posLeft="231" posTop="131" posWidth="129" posHeight="180"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="QueryBirthdayprint2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="QueryBirthdayprint2.php" forShow="True" url="QueryBirthdayprint2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
		<Group id="90" groupID="7"/>
		<Group id="91" groupID="6"/>
		<Group id="92" groupID="5"/>
		<Group id="93" groupID="4"/>
		<Group id="94" groupID="3"/>
		<Group id="95" groupID="2"/>
	</SecurityGroups>
	<CachingParameters/>
	<Attributes/>
	<Features/>
