<?php
//Include Common Files @1-7BE22555
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary6.php");
...
//Class_Initialize Event @22-3816EAEF
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary6.php";
            ...
            $this->Link3->Page = "Cert_latestsalary4.php";
            $this->Link10 = & new clsControl(ccsLink, "Link10", "Link10", ccsText, "", CCGetRequestParam("Link10", $Method, NULL), $this);
            $this->Link10->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
            $this->Link10->Page = "Cert_latestsalary2.php";
        }
    }
//End Class_Initialize Event
...
//CheckErrors Method @22-5035F0D3
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-7FB90FD3
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary6.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary6.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @22-B3BB1A17
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->Link10->Errors->ToString());
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary6.html";
$BlockToParse = "main";
...
//Include events file @1-276333D7
include_once("./Cert_latestsalary6_events.php");
...
$Link4->Page = "Cert_latestsalary_print.php";
...
$Link5->Page = "Cert_employment_print.php";
...
$Link6->Page = "Cert_AssumptnDuty.php";
$Link1 = & new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", ccsGet, NULL), $MainPage);
$Link1->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link1->Page = "Cert_nopending_his_print2.php";
...
$Link7->Page = "Cert_emp_compensatnPGDH_print.php";
...
$Link8->Page = "Cert_emp_compensatnAPGDH_print.php";
$Link14 = & new clsControl(ccsLink, "Link14", "Link14", ccsText, "", CCGetRequestParam("Link14", ccsGet, NULL), $MainPage);
$Link14->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
$Link14->Page = "Cert_emp_compensatnCOH_print.php";
...
$Link2->Page = "Cert_latestsalary3.php";
