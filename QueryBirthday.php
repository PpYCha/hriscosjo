<?php
//Include Common Files @1-0C9466CA
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QueryBirthday.php");
...
//departmentoffice_employee1 ReportGroup class @2-8A04A28B
...
//departmentoffice_employee1 GroupsCollection class @2-270AACF0
...
//Class_Initialize Event @2-9468D5BA
...
//DataSource Variables @2-AE247825
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-859F9245
...
//Open Method @2-F1ECDBFC
    function Open()
    {
        ...
        "lut_statofappt2.*, employee.Position AS employee_Position \n\n" .
...
//Class_Initialize Event @23-F30FE510
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "QueryBirthday.php";
...
//Operation Method @23-E78A57E5
    function Operation()
    {
        ...
        $Redirect = "QueryBirthday.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "QueryBirthday.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QueryBirthday.html";
$BlockToParse = "main";
...
//Include events file @1-F5949C1E
include_once("./QueryBirthday_events.php");
