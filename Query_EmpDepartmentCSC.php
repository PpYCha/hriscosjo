<?php
//Include Common Files @1-1613A55E
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Query_EmpDepartmentCSC.php");
...
//departmentoffice_employee1 ReportGroup class @2-E4ADA685
...
//departmentoffice_employee1 GroupsCollection class @2-00F54DD4
...
//Class_Initialize Event @2-82B6D2E8
    function clsReportdepartmentoffice_employee1($RelativePath = "", & $Parent)
    {
        ...
        $this->ReportLabel5 = & new clsControl(ccsReportLabel, "ReportLabel5", "ReportLabel5", ccsDate, array("mm", "/", "dd", "/", "yyyy"), "", $this);
...
//DataSource Variables @2-6B2EA218
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-7A84FB05
...
//Open Method @2-A1E6D082
    function Open()
    {
        ...
        "employee.Sex AS employee_Sex, BirthDate \n\n" .
...
//SetValues Method @2-3D8906FD
    function SetValues()
    {
        ...
        $this->ReportLabel5->SetDBValue(trim($this->f("BirthDate")));
        $this->ReportLabel6->SetDBValue($this->f("Sex"));
    }
...
//Class_Initialize Event @24-97DD5D39
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Query_EmpDepartmentCSC.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Query_EmpDepartmentCSC.html";
$BlockToParse = "main";
...
//Include events file @1-98C8DD5E
include_once("./Query_EmpDepartmentCSC_events.php");
