<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Fresh" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="100" connection="Connection1" dataSource="departmentoffice, employee, lut_statofappt2, lut_sex" name="departmentoffice_employee1" orderBy="employee.Surname" pageSizeLimit="100" wizardCaption=" Departmentoffice, Employee, Lut Statofappt2 " wizardLayoutType="GroupLeftAbove" activeCollection="TableParameters">
			<Components>
				...
				<Section id="44" visible="True" lines="1" name="Detail">
					<Components>
						...
						<ReportLabel id="116" fieldSourceType="DBColumn" dataType="Date" html="False" hideDuplicates="False" resetAt="Report" name="ReportLabel1" PathID="departmentoffice_employee1DetailReportLabel1" fieldSource="BirthDate" format="mmmm d, yyyy">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<Fields>
				...
				<Field id="115" tableName="employee" fieldName="BirthDate"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
		...
		<Record id="24" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="departmentoffice_employee" wizardCaption="Search Departmentoffice Employee " wizardOrientation="Vertical" wizardFormMethod="post" PathID="departmentoffice_employee" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
			<Components>
				<Link id="25" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ClearParameters" hrefSource="Query_EmpBday_PAcctO.ccp" removeParameters="s_employee_OfficeID;s_Surname;s_FirstName;s_MiddleName;ListBox1;s_employee_Position;s_ItemNo;s_SalaryGrade;s_StepIncrement;CheckBoxList1" wizardThemeItem="SorterLink" wizardDefaultValue="Clear" PathID="departmentoffice_employeeClearParameters">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="Query_EmpBday_PAcctO_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="Query_EmpBday_PAcctO.php" forShow="True" url="Query_EmpBday_PAcctO.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
