<?php
//Include Common Files @1-1362A5BA
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Cert_latestsalary1.php");
...
//Class_Initialize Event @22-5D95B56E
    function clsRecorddepartmentoffice_employee($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "Cert_latestsalary1.php";
            ...
            $this->Link4->Page = "Purpose4_copy_cert2.php";
        }
    }
//End Class_Initialize Event
...
//CheckErrors Method @22-155E8787
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @22-39482057
    function Operation()
    {
        ...
        $Redirect = "Cert_latestsalary1.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "Cert_latestsalary1.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Cert_latestsalary1.html";
$BlockToParse = "main";
...
//Include events file @1-BC623CCD
include_once("./Cert_latestsalary1_events.php");
