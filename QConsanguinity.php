<?php
//Include Common Files @1-A6A60294
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "QConsanguinity.php");
...
//employee ReportGroup class @2-00DA86EC
...
//employee GroupsCollection class @2-03AA0C9E
...
//Class_Initialize Event @2-30B89D13
    function clsReportemployee($RelativePath = "", & $Parent)
    {
        ...
        $this->DateAccomplished = & new clsControl(ccsReportLabel, "DateAccomplished", "DateAccomplished", ccsDate, $DefaultDateFormat, "", $this);
...
//DataSource Variables @2-85781F70
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-17DD0AB7
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "QConsanguinity.html";
$BlockToParse = "main";
...
//Include events file @1-5AA780F0
include_once("./QConsanguinity_events.php");
