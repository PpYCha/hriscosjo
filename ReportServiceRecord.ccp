<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Basic" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Report id="2" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" connection="Connection1" dataSource="employee, employee_servicerecord, signatories" name="employee_employee_service1" orderBy="DateFrom" pageSizeLimit="100" wizardCaption=" Employee, Employee Servicerecord, Signatories " wizardLayoutType="GroupAbove" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<Section id="25" visible="True" lines="1" name="Surname_Header" pasteActions="pasteActions">
					<Components>
				...
				<Section id="37" visible="True" lines="2" name="PlaceOfBirth_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ImageLink id="99" visible="Yes" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ImageLink1" PathID="employee_employee_service1PlaceOfBirth_HeaderImageLink1">
							<Components/>
							<Events/>
							<LinkParameters/>
							<Attributes/>
				...
				<Section id="48" visible="True" lines="2" name="Page_Footer" wizardSectionType="PageFooter" pageBreakAfter="True" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
					<Components>
		...
		<Link id="18" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Report_Print" hrefSource="ReportServiceRecord.ccp" wizardTheme="Joyful" wizardThemeType="File" wizardDefaultValue="Printable version" wizardUseTemplateBlock="True" wizardBeforeHTML="&lt;p align=&quot;right&quot;&gt;" wizardAfterHTML="&lt;/p&gt;" wizardLinkTarget="_blank" PathID="Report_Print">
			<Components/>
			<Events>
				<Event name="BeforeShow" type="Server">
					<Actions>
		...
		<Link id="104" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" PathID="Link1" hrefSource="index.ccp" wizardUseTemplateBlock="False">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="ReportServiceRecord_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="ReportServiceRecord.php" forShow="True" url="ReportServiceRecord.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
		<Group id="101" groupID="3"/>
		<Group id="102" groupID="2"/>
