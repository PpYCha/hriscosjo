...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="Cert_nopending_his_print.php" forShow="True" url="Cert_nopending_his_print.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="Cert_nopending_his_print_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
